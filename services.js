// ==========================================
// SEVACHECK KERALA — SERVICE DATABASE (80 SERVICES)
// File: services.js
// ==========================================
const servicesData = [
// =========================================================================
...
summary: {
en: "Certifies that an applicant belongs to a nationally or state-notified religious or linguistic minority community.",
ml: "അപേക്ഷകൻ ദേശീയതലത്തിലോ സംസ്ഥാനതലത്തിലോ അംഗീകരിക്കപ്പെട്ട ന്യൂനപക്ഷ വിഭാഗത്തിൽപ്പെട്ടയാളാണെന്ന് സാക്ഷ്യപ്പെടുത്തുന്ന രേഖ."
},
whoNeeds: {
en: "Students and applicants applying for minority quota admissions, welfare scholarships, or central/state development schemes.",
ml: "ന്യൂനപക്ഷ ക്വാട്ട വഴിയുള്ള പ്രവേശനം, പ്രത്യേക സ്കോളർഷിപ്പുകൾ എന്നിവയ്ക്ക് അപേക്ഷിക്കുന്നവർ."
},
eligibility: {
en: "Kerala residents belonging to notified minority communities (e.g., Muslim, Christian, Sikh, Buddhist, Jain, Parsi).",
ml: "വിജ്ഞാപനം ചെയ്യപ്പെട്ട ന്യൂനപക്ഷ സമുദായങ്ങളിൽ ഉൾപ്പെടുന്ന കേരളത്തിലെ സ്ഥിരതാമസക്കാർ."
},
documents: {
en: [
"Aadhaar / Recognized Photo Identity Proof",
"SSLC Book / Transfer Certificate proving religion",
"Ration Card copy",
"Self-declaration statement"
],
ml: [
"ആധാർ അല്ലെങ്കിൽ തിരിച്ചറിയൽ രേഖ",
"മതം വ്യക്തമാക്കുന്ന എസ്.എസ്.എൽ.സി / ടി.സി പകർപ്പ്",
"റേഷൻ കാർഡ് പകർപ്പ്",
"സ്വയം സാക്ഷ്യപ്പെടുത്തിയ അപേക്ഷ"
]
},
additionalDocs: {
en: [
"Certificate from religious community authority if school certificates do not mention religion"
],
ml: [
"സ്കൂൾ രേഖകളിൽ മതം വ്യക്തമാക്കിയിട്ടില്ലെങ്കിൽ മതസ്ഥാപന അധികാരിയുടെ സാക്ഷ്യപത്രം"
]
},
whereToApply: {
en: "Kerala e-District Portal or local Revenue Village Office.",
ml: "കേരള ഇ-ഡിസ്ട്രിക്റ്റ് പോർട്ടൽ അല്ലെങ്കിൽ വില്ലേജ് ഓഫീസ് / അക്ഷയ കേന്ദ്രം."
},
mode: {
en: "Online & Offline",
...
steps: {
en: [
"Submit applicant details and attach school and identity documents on e-District.",
"Village Officer verifies records and forwards report to Tahsildar.",
"Competent Revenue authority sanctions certificate.",
"Download digitally signed certificate from the portal."
],
ml: [
"ഇ-ഡിസ്ട്രിക്റ്റ് വഴി രേഖകൾ സഹിതം അപേക്ഷ സമർപ്പിക്കുക.",
"വില്ലേജ് ഓഫീസർ രേഖകൾ പരിശോധിച്ച് റിപ്പോർട്ട് നൽകുന്നു.",
"റവന്യൂ അധികൃതർ പരിശോധിച്ച് സർട്ടിഫിക്കറ്റ് അനുവദിക്കുന്നു.",
"പോർട്ടലിൽ നിന്ന് സർട്ടിഫിക്കറ്റ് ഡൗൺലോഡ് ചെയ്യുക."
]
},
officialUrl: "https://edistrict.kerala.gov.in",
notes: {
en: "Requirements may vary based on whether the quota applied for is under Central or State jurisdiction.",
ml: "കേന്ദ്ര-സംസ്ഥാന പദ്ധതികൾക്കനുസരിച്ച് മാനദണ്ഡങ്ങളിൽ വ്യത്യാസം വന്നേക്കാം."
},
lastVerified: "September 2026",
verified: true
},
...
ml: "നോൺ-ക്രീമി ലെയർ സർട്ടിഫിക്കറ്റ്"
},
summary: {
en: "Certifies that a backward class candidate does not fall into the affluent (creamy) layer, enabling quota reservations.",
ml: "പിന്നാക്ക സമുദായങ്ങളിൽപ്പെട്ടവർ സംവരണ പരിധിയിൽ വരുന്ന സാമ്പത്തിക വിഭാഗത്തിലാണെന്ന് (ക്രീമിലെയറിൽ ഉൾപ്പെടുന്നില്ല) സാക്ഷ്യപ്പെടുത്തുന്ന രേഖ."
},
whoNeeds: {
en: "OBC/SEBC candidates applying for Central/State government jobs, UPSC, PSC, or entrance exams like KEAM/NEET.",
ml: "പി.എസ്.സി, യു.പി.എസ്.സി, നീറ്റ്, കീം തുടങ്ങിയ പരീക്ഷകളിലും സർക്കാർ ജോലികളിലും സംവരണം ആവശ്യപ്പെടുന്നവർ."
},
eligibility: {
en: "Members of recognized backward classes whose gross annual parental income is below the statutory limit (excluding salary/agricultural rules where applicable).",
ml: "അംഗീകൃത പിന്നാക്ക വിഭാഗത്തിൽപ്പെട്ട, നിശ്ചിത വരുമാന പരിധിക്ക് താഴെയുള്ള കുടുംബങ്ങളിലെ ഉദ്യോഗാർത്ഥികൾ."
},
documents: {
en: [
"Aadhaar / Photo Identity Proof",
"Community Certificate / SSLC Certificate showing caste/community",
"Salary Certificate (for government/formal employees) or Form 16",
"Income Certificate / IT returns of parents",
"Ration Card copy"
],
ml: [
"ആധാർ / തിരിച്ചറിയൽ കാർഡ്",
"സമുദായം വ്യക്തമാക്കുന്ന എസ്.എസ്.എൽ.സി / കമ്മ്യൂണിറ്റി സർട്ടിഫിക്കറ്റ്",
"മാതാപിതാക്കളുടെ ശമ്പള സർട്ടിഫിക്കറ്റ് / ആദായനികുതി റിട്ടേൺ",
...
additionalDocs: {
en: [
"Land holding and agricultural income proof if parental assets involve extensive farmland"
],
ml: [
"കാർഷിക ഭൂമിയുടെ വിശദാംശങ്ങൾ സംബന്ധിച്ച രേഖകൾ (ബാധകമെങ്കിൽ)"
]
},
whereToApply: {
...
steps: {
en: [
"Apply on e-District portal selecting state or central government format.",
"Upload parental income proofs, caste proof, and tax remittances.",
"Village Officer and Revenue Inspector conduct scrutiny.",
"Tahsildar approves and issues digitally signed certificate."
],
ml: [
"സംസ്ഥാന അല്ലെങ്കിൽ കേന്ദ്ര ഫോർമാറ്റ് തിരഞ്ഞെടുത്ത് ഇ-ഡിസ്ട്രിക്റ്റ് വഴി അപേക്ഷിക്കുക.",
"മാതാപിതാക്കളുടെ വരുമാന രേഖകളും ജാതി രേഖകളും അപ്‌ലോഡ് ചെയ്യുക.",
"റവന്യൂ പരിശോധനയ്ക്ക് ശേഷം തഹസിൽദാർ സർട്ടിഫിക്കറ്റ് അനുവദിക്കുന്നു."
]
},
officialUrl: "https://edistrict.kerala.gov.in",
notes: {
en: "Specify whether certificate is required for Kerala State services or Central Government (Government of India) services.",
ml: "കേന്ദ്ര സർവീസ് ആവശ്യങ്ങൾക്കാണോ സംസ്ഥാന ആവശ്യങ്ങൾക്കാണോ എന്ന് അപേക്ഷയിൽ വ്യക്തമാക്കേണ്ടതുണ്ട്."
},
lastVerified: "September 2026",
verified: true
},
...
summary: {
en: "Revenue document certifying that a widow, widower, or divorced individual has not entered into remarriage.",
ml: "വിധവയോ വിവാഹമോചിതരോ പുനർവിവാഹം ചെയ്തിട്ടില്ലെന്ന് സാക്ഷ്യപ്പെടുത്തുന്ന റവന്യൂ രേഖ."
},
whoNeeds: {
en: "Individuals drawing family pensions, widow pensions, or compassionate allowance from state/central bodies.",
ml: "കുടുംബ പെൻഷൻ, വിധവാ പെൻഷൻ എന്നിവ തടസ്സമില്ലാതെ ലഭിക്കുന്നതിനായി ഗുണഭോക്താക്കൾ."
},
eligibility: {
en: "Surviving spouses or pension beneficiaries residing in Kerala who have not legally or customarily remarried.",
ml: "പുനർവിവാഹം കഴിച്ചിട്ടില്ലാത്ത പെൻഷൻ ഗുണഭോക്താക്കൾ."
},
documents: {
en: [
"Aadhaar / Photo Identity Proof",
"Death Certificate of the deceased spouse (or Divorce decree)",
"Pension payment book / PPO copy",
"Self-declaration affidavit of non-remarriage"
],
ml: [
"ആധാർ / തിരിച്ചറിയൽ കാർഡ്",
"ഭർത്താവിന്റെ/ഭാര്യയുടെ മരണ സർട്ടിഫിക്കറ്റ് (അല്ലെങ്കിൽ വിവാഹമോചന ഉത്തരവ്)",
"പെൻഷൻ ബുക്ക് / PPO പകർപ്പ്",
"പുനർവിവാഹം ചെയ്തിട്ടില്ലെന്ന സത്യവാങ്മൂലം"
]
},
additionalDocs: {
en: [
"Ration card copy showing current resident family members"
],
ml: [
"കുടുംബാംഗങ്ങളെ വ്യക്തമാക്കുന്ന റേഷൻ കാർഡ് പകർപ്പ്"
]
},
whereToApply: {
en: "Kerala e-District Portal or local Village Office / Akshaya Centre.",
...
steps: {
en: [
"Apply via e-District uploading identity proof, spouse death certificate, and affidavit.",
"Village Officer verifies local marital status via field inquiry.",
"Digitally signed certificate is approved and issued.",
"Submit certificate to Treasury or Pension Disbursing Authority."
],
ml: [
"ഇ-ഡിസ്ട്രിക്റ്റ് വഴി സത്യവാങ്മൂലവും രേഖകളും സമർപ്പിക്കുക.",
"വില്ലേജ് ഓഫീസർ പ്രാദേശികമായി അന്വേഷണം നടത്തി റിപ്പോർട്ട് നൽകുന്നു.",
"അംഗീകൃത സർട്ടിഫിക്കറ്റ് ട്രഷറിയിലോ പെൻഷൻ ഓഫീസിലോ ഹാജരാക്കുക."
]
},
officialUrl: "https://edistrict.kerala.gov.in",
notes: {
en: "Most pension authorities require this certificate annually along with the Life Certificate.",
ml: "പല പെൻഷൻ പദ്ധതികളിലും വർഷം തോറും ലൈഫ് സർട്ടിഫിക്കറ്റിനൊപ്പം ഇത് സമർപ്പിക്കേണ്ടി വരാറുണ്ട്."
},
lastVerified: "September 2026",
verified: true
},
...
ml: "ഒന്നും അതേ വ്യക്തിയുമാണെന്ന സർട്ടിഫിക്കറ്റ്"
},
summary: {
en: "Certifies that variations or minor spelling discrepancies in an individual's name across different records refer to the same person.",
ml: "വ്യത്യസ്ത രേഖകളിലെ പേരുകളിലെ വ്യത്യാസങ്ങൾ ഒരേ വ്യക്തിയുടേത് തന്നെയാണെന്ന് തെളിയിക്കുന്ന റവന്യൂ സാക്ഷ്യപത്രം."
},
whoNeeds: {
en: "Individuals whose names or initials differ between SSLC, Aadhaar, Passport, or property deeds.",
ml: "എസ്.എസ്.എൽ.സി, ആധാർ, പാസ്‌പോർട്ട്, പ്രമാണങ്ങൾ എന്നിവയിൽ പേരിലോ ഇനീഷ്യലിലോ വ്യത്യാസമുള്ളവർ."
},
eligibility: {
en: "Any resident of Kerala facing administrative delays due to name discrepancies across statutory documents.",
ml: "രേഖകളിലെ പേരു വ്യത്യാസം മൂലം ബുദ്ധിമുട്ട് നേരിടുന്ന കേരളത്തിലെ താമസക്കാർ."
},
documents: {
en: [
"All original documents showing the varying names (e.g., SSLC, Passport, Aadhaar)",
"Notarized Affidavit explaining the name differences",
"Ration card copy",
"Passport size photograph"
],
ml: [
"വ്യത്യസ്ത പേരുകൾ കാണിക്കുന്ന രേഖകളുടെ പകർപ്പുകൾ (SSLC, ആധാർ മുതലായവ)",
...
additionalDocs: {
en: [
"Kerala Gazette notification copy if an official name change was executed"
],
ml: [
"ഔദ്യോഗികമായി പേര് മാറ്റിയതാണെങ്കിൽ ഗസറ്റ് വിജ്ഞാപന പകർപ്പ്"
]
},
whereToApply: {
en: "Kerala e-District Portal or local Village Office / Tahsildar.",
ml: "കേരള ഇ-ഡിസ്ട്രിക്റ്റ് പോർട്ടൽ അല്ലെങ്കിൽ വില്ലേജ് / താലൂക്ക് ഓഫീസ്."
},
mode: {
en: "Online & Village Office",
ml: "ഓൺലൈൻ & വില്ലേജ് ഓഫീസ്"
...
steps: {
en: [
"Submit documents showing the different name versions on e-District.",
"Attach notarized affidavit affirming identity.",
"Village Officer checks identity and certifies that both names identify one and the same person.",
"Download signed certificate from portal."
],
ml: [
"വ്യത്യസ്ത പേരുകളുള്ള രേഖകളും സത്യവാങ്മൂലവും പോർട്ടലിൽ അപ്‌ലോഡ് ചെയ്യുക.",
"വില്ലേജ് ഓഫീസർ പരിശോധന നടത്തി രേഖകളിലുള്ളത് ഒരേ വ്യക്തിയാണെന്ന് സാക്ഷ്യപ്പെടുത്തുന്നു.",
"സർട്ടിഫിക്കറ്റ് ഡൗൺലോഡ് ചെയ്ത് ഉപയോഗിക്കാം."
]
},
officialUrl: "https://edistrict.kerala.gov.in",
notes: {
en: "Not a substitute for official gazetted name change; intended only to clarify minor clerical variations.",
ml: "ഇത് പേര് മാറ്റാനുള്ള രേഖയല്ല; നിലവിലുള്ള രേഖകളിലെ നിസ്സാര പൊരുത്തക്കേടുകൾ പരിഹരിക്കാനുള്ളതാണ്."
},
lastVerified: "September 2026",
verified: true
},
...
ml: "വിധവ/വിധവൻ സർട്ടിഫിക്കറ്റ്"
},
summary: {
en: "Official certificate establishing the death of a spouse and confirming widow/widower status.",
ml: "ഭർത്താവ് അല്ലെങ്കിൽ ഭാര്യ മരണപ്പെട്ടുവെന്നും അപേക്ഷകൻ വിധവ/വിധവൻ ആണെന്നും സാക്ഷ്യപ്പെടുത്തുന്ന റവന്യൂ രേഖ."
},
whoNeeds: {
en: "Surviving spouses seeking welfare benefits, housing quotas, debt waivers, or social security assistance.",
ml: "വിധവാ പെൻഷൻ, ഭവന പദ്ധതികൾ, മറ്റ് സർക്കാർ ക്ഷേമ ആനുകൂല്യങ്ങൾ എന്നിവയ്ക്ക് അപേക്ഷിക്കുന്നവർ."
},
eligibility: {
en: "Residents of Kerala whose legal spouse has passed away and who remain unmarried.",
ml: "ഭാര്യയോ ഭർത്താവോ മരണപ്പെട്ട കേരളത്തിലെ താമസക്കാർ."
},
documents: {
en: [
"Death Certificate of the spouse",
"Aadhaar / Photo Identity Proof of applicant",
"Ration Card copy",
"Marriage Certificate or joint identity proof confirming marital link"
],
ml: [
"പങ്കാളിയുടെ മരണ സർട്ടിഫിക്കറ്റ്",
"അപേക്ഷകന്റെ ആധാർ / തിരിച്ചറിയൽ കാർഡ്",
"റേഷൻ കാർഡ് പകർപ്പ്",
"വിവാഹ ബന്ധം തെളിയിക്കുന്ന രേഖ / സർട്ടിഫിക്കറ്റ്"
]
},
additionalDocs: {
en: [
"Self-declaration stating the applicant has not remarried"
],
ml: [
"പുനർവിവാഹം കഴിച്ചിട്ടില്ലെന്ന സ്വയം സാക്ഷ്യപ്പെടുത്തൽ"
]
},
whereToApply: {
en: "Kerala e-District Portal or local Village Office / Akshaya Centre.",
...
steps: {
en: [
"Upload spouse death certificate, marriage evidence, and ID on e-District.",
"Village Officer performs verification and issues enquiry report.",
"Competent Revenue officer sanctions the certificate.",
"Download signed certificate from the dashboard."
],
ml: [
"ഇ-ഡിസ്ട്രിക്റ്റ് വഴി മരണ സർട്ടിഫിക്കറ്റും തിരിച്ചറിയൽ രേഖകളും സമർപ്പിക്കുക.",
"വില്ലേജ് ഓഫീസറുടെ അന്വേഷണത്തിന് ശേഷം സർട്ടിഫിക്കറ്റ് അനുവദിക്കുന്നു.",
"ഓൺലൈനായി സർട്ടിഫിക്കറ്റ് ഡൗൺലോഡ് ചെയ്യാം."
]
},
officialUrl: "https://edistrict.kerala.gov.in",
notes: {
...
ml: "ലൈഫ് സർട്ടിഫിക്കറ്റ് (ജീവൻ പ്രമാൺ)"
},
summary: {
en: "Biometric digital verification of existence submitted annually by pensioners to continue pension credits.",
ml: "പെൻഷൻ മുടങ്ങാതെ ലഭിക്കുന്നതിനായി പെൻഷൻകാർ ജീവിച്ചിരിപ്പുണ്ടെന്ന് വർഷം തോറും തെളിയിക്കുന്ന ഡിജിറ്റൽ സാക്ഷ്യപത്രം."
},
whoNeeds: {
en: "State and central government pensioners, defense retirees, and EPF pensioners.",
ml: "കേരള സർക്കാർ, കേന്ദ്ര സർക്കാർ, ഇ.പി.എഫ്, ബാങ്ക് പെൻഷൻ വാങ്ങുന്ന എല്ലാ പെൻഷൻകാരും."
},
eligibility: {
en: "Pensioners drawing pensions through banks, treasuries, or post offices.",
ml: "ട്രഷറി അല്ലെങ്കിൽ ബാങ്ക് വഴി പെൻഷൻ കൈപ്പറ്റുന്ന വ്യക്തികൾ."
},
documents: {
en: [
"Aadhaar Number",
"Pension Payment Order (PPO) Number",
"Pension Disbursing Bank Account details",
"Registered mobile phone for OTP"
],
ml: [
"ആധാർ നമ്പർ",
"പി.പി.ഒ (PPO) നമ്പർ",
"പെൻഷൻ അക്കൗണ്ട് വിവരങ്ങൾ",
"മൊബൈൽ ഫോൺ (OTP ലഭിക്കാൻ)"
]
},
additionalDocs: {
en: [
"Doctor's certificate in case of bedridden pensioners unable to provide biometrics"
],
ml: [
"കിടപ്പുരോഗികളാണെങ്കിൽ ഡോക്ടറുടെ സാക്ഷ്യപത്രം"
]
},
whereToApply: {
en: "Jeevan Pramaan portal / App, Post Office doorstep service, or local Akshaya Centre / Treasury.",
ml: "ജീവൻ പ്രമാൺ പോർട്ടൽ, പോസ്റ്റ് ഓഫീസ് ഡോർസ്റ്റെപ്പ് സേവനം, അല്ലെങ്കിൽ അക്ഷയ കേന്ദ്രം / ട്രഷറി."
},
mode: {
en: "Biometric Online / Doorstep Postman Service",
ml: "ബയോമെട്രിക് ഡിജിറ്റൽ സേവനം & പോസ്റ്റ് ഓഫീസ്"
},
steps: {
en: [
"Visit Akshaya, Post Office, or use Jeevan Pramaan mobile face recognition app.",
"Provide PPO number, bank account details, and Aadhaar number.",
"Perform biometric fingerprint/iris scan or facial authentication.",
"Pramaan ID is generated, and digital life certificate is automatically pushed to the Pension Disbursing Agency."
],
ml: [
"അക്ഷയ കേന്ദ്രത്തിലോ ജീവൻ പ്രമാൺ ആപ്പ് വഴിയോ ആധാർ വിവരങ്ങളും PPO നമ്പറും നൽകുക.",
"വിരലടയാളം വഴിയോ ഫേസ് റെക്കഗ്നിഷൻ വഴിയോ ബയോമെട്രിക് സ്ഥിരീകരണം നടത്തുക.",
"ഡിജിറ്റൽ സർട്ടിഫിക്കറ്റ് നേരിട്ട് ട്രഷറി/ബാങ്ക് സിസ്റ്റത്തിലേക്ക് അപ്‌ഡേറ്റ് ആകുന്നു."
]
},
officialUrl: "https://jeevanpramaan.gov.in",
notes: {
en: "Doorstep biometric generation through India Post Payments Bank (IPPB) postmen is widely available across Kerala.",
ml: "പോസ്റ്റ്മാൻ വഴി വീട്ടിലെത്തി ലൈഫ് സർട്ടിഫിക്കറ്റ് തയ്യാറാക്കുന്ന സൗകര്യം ലഭ്യമാണ്."
},
lastVerified: "September 2026",
verified: true
},
...
ml: "അന്തർജാതി വിവാഹ സർട്ടിഫിക്കറ്റ്"
},
summary: {
en: "Official document certifying that a legally married couple belongs to two different castes or communities.",
ml: "വിവാഹിതരായ ദമ്പതികൾ രണ്ട് വ്യത്യസ്ത ജാതിയിലോ സമുദായത്തിലോ ഉള്ളവരാണെന്ന് സാക്ഷ്യപ്പെടുത്തുന്ന റവന്യൂ രേഖ."
},
whoNeeds: {
en: "Inter-caste couples applying for government financial incentives, employment preferences, or welfare schemes.",
ml: "സർക്കാർ നൽകുന്ന സാമ്പത്തിക സഹായം, മറ്റ് ആനുകൂല്യങ്ങൾ എന്നിവയ്ക്കായി അപേക്ഷിക്കുന്ന മിശ്രവിവാഹിതർ."
},
eligibility: {
en: "Legally married couples residing in Kerala where the spouses belong to distinct castes (especially SC/ST with non-SC/ST).",
ml: "രണ്ട് വ്യത്യസ്ത ജാതികളിൽപ്പെട്ട നിയമപരമായി വിവാഹിതരായ കേരളത്തിലെ ദമ്പതികൾ."
},
documents: {
en: [
"Registered Marriage Certificate",
"Caste / Community Certificates of both spouses (or SSLC Book extracts)",
"Joint photograph of the couple",
"Aadhaar / Photo IDs of both parties",
"Ration Card copy"
],
ml: [
"രജിസ്റ്റർ ചെയ്ത വിവാഹ സർട്ടിഫിക്കറ്റ്",
"ഇരുവരുടെയും ജാതി സർട്ടിഫിക്കറ്റുകൾ അല്ലെങ്കിൽ SSLC പകർപ്പ്",
"ദമ്പതികളുടെ സംയുക്ത ഫോട്ടോ",
"ഇരുവരുടെയും ആധാർ / തിരിച്ചറിയൽ കാർഡുകൾ",
"റേഷൻ കാർഡ് പകർപ്പ്"
]
},
additionalDocs: {
en: [
"Inquiry report from District Social Justice / Scheduled Caste Development department if claiming financial grant"
],
ml: [
"സാമ്പത്തിക സഹായത്തിനാണെങ്കിൽ സാമൂഹ്യനീതി/പട്ടികജാതി വികസന ഓഫീസറുടെ അന്വേഷണ റിപ്പോർട്ട്"
]
},
whereToApply: {
en: "Kerala e-District Portal or local Village/Taluk Office.",
ml: "കേരള ഇ-ഡിസ്ട്രിക്റ്റ് പോർട്ടൽ അല്ലെങ്കിൽ വില്ലേജ് ഓഫീസ് / താലൂക്ക് ഓഫീസ്."
},
mode: {
en: "Online & Field Inquiry",
ml: "ഓൺലൈൻ & വില്ലേജ് തല അന്വേഷണം"
},
steps: {
en: [
"Submit joint application on e-District with marriage certificate and caste records of both spouses.",
"Village Officer verifies legal validity of marriage and distinct caste backgrounds.",
"Tahsildar approves and issues the certificate.",
"Download signed certificate from the dashboard."
],
ml: [
"ഇ-ഡിസ്ട്രിക്റ്റ് വഴി വിവാഹ രേഖകളും ഇരുവരുടെയും ജാതി രേഖകളും സമർപ്പിക്കുക.",
"വില്ലേജ് ഓഫീസറുടെ പരിശോധനയ്ക്ക് ശേഷം തഹസിൽദാർ സർട്ടിഫിക്കറ്റ് നൽകുന്നു.",
"പോർട്ടലിൽ നിന്ന് സർട്ടിഫിക്കറ്റ് ഡൗൺലോഡ് ചെയ്യാം."
]
},
officialUrl: "https://edistrict.kerala.gov.in",
notes: {
en: "Both spouses must be legally married with registration under statutory marriage laws.",
ml: "വിവാഹം ഔദ്യോഗികമായി രജിസ്റ്റർ ചെയ്തതാണെന്ന് ഉറപ്പുവരുത്തേണ്ടതുണ്ട്."
},
lastVerified: "September 2026",
verified: true
},
...
ml: "കൈവശവും ബാധ്യതയില്ലായ്മയും സംബന്ധിച്ച സർട്ടിഫിക്കറ്റ്"
},
summary: {
en: "Certifies that a property is in lawful possession of the applicant and free from revenue recovery or court attachments.",
ml: "ഭൂമി അപേക്ഷകന്റെ കൈവശത്തിലാണെന്നും റവന്യൂ റിക്കവറിയോ കോടതി ജപ്തിയോ നിലവിലില്ലെന്നും സാക്ഷ്യപ്പെടുത്തുന്ന രേഖ."
},
whoNeeds: {
en: "Landowners applying for commercial/mortgage bank loans, government guarantees, or institutional tenders.",
ml: "ബാങ്ക് വായ്പകൾ, ഈട് നിൽക്കൽ, മറ്റ് ഔദ്യോഗിക ആവശ്യങ്ങൾ എന്നിവയ്ക്കായി ഭൂവുടമകൾ."
},
eligibility: {
en: "Titleholders of land in Kerala whose properties have no pending court attachments or government revenue recovery warrants.",
ml: "കോടതി അറ്റാച്ച്മെന്റോ റവന്യൂ റിക്കവറിയോ ഇല്ലാത്ത ഭൂമിയുടെ ഉടമസ്ഥർ."
},
documents: {
en: [
"Title Deed (Aadhaaram) of the property",
...
additionalDocs: {
en: [
"Location sketch and possession certificate extract"
],
ml: [
"ലൊക്കേഷൻ സ്കെച്ചും കൈവശാവകാശ രേഖയും"
]
},
whereToApply: {
...
steps: {
en: [
"Apply via e-District uploading title deed, tax receipt, and EC.",
"Village Officer checks revenue attachment registers and conducts field verification.",
"Village Officer certifies peaceful possession and absence of state liability.",
"Download digitally signed certificate from portal."
],
ml: [
"ഇ-ഡിസ്ട്രിക്റ്റ് വഴി ആധാരവും ബാധ്യതാ രേഖകളും സമർപ്പിക്കുക.",
"വില്ലേജ് റിക്കവറി രജിസ്റ്ററുകൾ പരിശോധിച്ച് ഉദ്യോഗസ്ഥൻ അനുമതി നൽകുന്നു.",
"സർട്ടിഫിക്കറ്റ് ഓൺലൈനായി ഡൗൺലോഡ് ചെയ്യാം."
]
},
officialUrl: "https://edistrict.kerala.gov.in",
notes: {
en: "Ensure all municipal and basic land taxes are remitted up to date before filing application.",
ml: "അപേക്ഷിക്കുന്നതിന് മുൻപ് നികുതി കുടിശ്ശികകൾ ഒന്നുമില്ലെന്ന് ഉറപ്പാക്കുക."
},
lastVerified: "September 2026",
verified: true
},
...
ml: "മൂല്യനിർണ്ണയ സർട്ടിഫിക്കറ്റ്"
},
summary: {
en: "Revenue Department certificate establishing the fair value or assessed market value of immovable property.",
ml: "ഭൂമിയുടെയോ കെട്ടിടത്തിന്റെയോ ന്യായവിലയും മതിപ്പുമൂല്യവും സാക്ഷ്യപ്പെടുത്തുന്ന റവന്യൂ രേഖ."
},
whoNeeds: {
en: "Citizens executing property transfers, securing bank project loans, probate of wills, or foreign visa asset proof.",
ml: "ബാങ്ക് വായ്പകൾ, വിസ ആവശ്യങ്ങൾക്കുള്ള സാമ്പത്തിക സ്ഥിതി തെളിയിക്കൽ, സ്വത്ത് കൈമാറ്റം എന്നിവയ്ക്ക്."
},
eligibility: {
en: "Owners of landed property located within Kerala.",
ml: "കേരളത്തിൽ വസ്തുവകകൾ ഉള്ള ഉടമസ്ഥർ."
},
documents: {
en: [
"Registered Title Deed (Aadhaaram)",
...
"Aadhaar / Photo ID proof",
"Building completion/tax receipt (if valuation includes structure)"
],
ml: [
"ആധാരത്തിന്റെ പകർപ്പ്",
"ഭൂനികുതി രസീത്",
...
"ആധാർ / തിരിച്ചറിയൽ രേഖ",
"കെട്ടിട നികുതി രസീത് (കെട്ടിടം ഉൾപ്പെടുന്നതാണെങ്കിൽ)"
]
},
additionalDocs: {
en: [
"Approved valuer estimate or Public Works Department (PWD) structural cost schedule"
],
ml: [
"അംഗീകൃത എൻജിനീയറുടെ മൂല്യനിർണ്ണയ എസ്റ്റിമേറ്റ് (ആവശ്യമെങ്കിൽ)"
]
},
whereToApply: {
en: "Revenue Department via e-District Portal or Taluk Office / Tahsildar.",
ml: "റവന്യൂ പോർട്ടൽ അല്ലെങ്കിൽ താലൂക്ക് ഓഫീസ് / തഹസിൽദാർ."
},
mode: {
en: "Online & Taluk Assessment",
ml: "ഓൺലൈൻ & താലൂക്ക് പരിശോധന"
},
steps: {
en: [
"Apply online uploading title deed and tax remittance records.",
"Village Officer and Tahsildar verify fair value notification schedules.",
"Site inspection is performed if structural assets are evaluated.",
"Tahsildar issues official Valuation Certificate."
],
ml: [
"ഇ-ഡിസ്ട്രിക്റ്റ് വഴി പ്രമാണങ്ങളും രേഖകളും സമർപ്പിക്കുക.",
"റവന്യൂ ഉദ്യോഗസ്ഥർ ന്യായവില പട്ടിക പരിശോധിച്ച് മൂല്യം നിശ്ചയിക്കുന്നു.",
"തഹസിൽദാർ പരിശോധിച്ച് സർട്ടിഫിക്കറ്റ് അനുവദിക്കുന്നു."
]
},
officialUrl: "https://edistrict.kerala.gov.in",
notes: {
en: "Land valuation strictly references the notified fair value registers maintained by the Kerala Department of Taxes/Registration.",
ml: "രജിസ്ട്രേഷൻ വകുപ്പിന്റെ ഔദ്യോഗിക ന്യായവില പട്ടികയ്ക്ക് വിധേയമായാണ് മൂല്യം നിശ്ചയിക്കുന്നത്."
},
lastVerified: "September 2026",
verified: true
},
{
id: "accident-gd-certificate",
category: "documents",
icon: "📋",
name: {
en: "Accident GD Certificate",
ml: "അപകടവുമായി ബന്ധപ്പെട്ട GD സർട്ടിഫിക്കറ്റ്"
},
summary: {
en: "Certified General Diary (GD) extract issued by the police documenting vehicle collisions or damage for insurance claims.",
ml: "വാഹനാപകടങ്ങൾ സംബന്ധിച്ച് പോലീസ് സ്റ്റേഷനിൽ രേഖപ്പെടുത്തിയ ജനറൽ ഡയറി (GD) വിവരങ്ങളുടെ സാക്ഷ്യപ്പെടുത്തിയ പകർപ്പ്."
},
whoNeeds: {
en: "Motor vehicle owners or drivers claiming third-party or own-damage insurance where full FIR registration was not required.",
ml: "വാഹന ഇൻഷുറൻസ് ക്ലെയിം ലഭിക്കുന്നതിനായി അപകടവിവരം രേഖപ്പെടുത്തിയ പോലീസ് രേഖ ആവശ്യമുള്ളവർ."
},
eligibility: {
en: "Registered owner, authorized driver, or insurer of a vehicle involved in a reported road traffic incident in Kerala.",
ml: "കേരളത്തിൽ വാഹനാപകടത്തിൽപ്പെട്ട വാഹനത്തിന്റെ ഉടമസ്ഥനോ ഡ്രൈവർക്കോ."
},
documents: {
en: [
...
"Written application mentioning date, time, and scene of accident",
"Aadhaar / Recognized Photo ID"
],
ml: [
"ഡ്രൈവിംഗ് ലൈസൻസ് പകർപ്പ്",
"ആർ.സി ബുക്ക് പകർപ്പ്",
"വാഹന ഇൻഷുറൻസ് പോളിസി",
"അപകട തീയതിയും സ്ഥലവും വ്യക്തമാക്കുന്ന അപേക്ഷ",
"ആധാർ / തിരിച്ചറിയൽ രേഖ"
]
},
additionalDocs: {
en: [
"Photographs of damaged vehicle at the scene"
],
ml: [
"അപകടത്തിൽപ്പെട്ട വാഹനത്തിന്റെ ഫോട്ടോകൾ"
]
},
whereToApply: {
en: "Kerala Police Thuna Portal (thuna.keralapolice.gov.in) or jurisdictional Police Station.",
ml: "കേരള പോലീസ് തുണ പോർട്ടൽ അല്ലെങ്കിൽ ബന്ധപ്പെട്ട പോലീസ് സ്റ്റേഷൻ."
},
mode: {
en: "Online & Police Station",
ml: "ഓൺലൈൻ & പോലീസ് സ്റ്റേഷൻ"
},
steps: {
en: [
"Report incident promptly to the jurisdictional police station or via Thuna portal.",
"Provide vehicle registration, insurance, and damage details.",
"Duty officer verifies accident report in the General Diary.",
"Pay prescribed nominal fee and download/collect the certified GD extract."
],
ml: [
"അപകടവിവരം ഉടൻ പോലീസ് സ്റ്റേഷനിലോ തുണ പോർട്ടൽ വഴിയോ അറിയിക്കുക.",
"വാഹന രേഖകളും ഇൻഷുറൻസ് വിവരങ്ങളും നൽകുക.",
"ജനറൽ ഡയറി പരിശോധനയ്ക്ക് ശേഷം ഫീസ് അടച്ച് സാക്ഷ്യപ്പെടുത്തിയ ജി.ഡി പകർപ്പ് വാങ്ങുക."
]
},
officialUrl: "https://thuna.keralapolice.gov.in",
notes: {
en: "Applicable mainly for minor non-injury vehicle damages; serious accidents involving injuries require a formal First Information Report (FIR).",
ml: "പരിക്കുകളില്ലാത്ത ചെറിയ അപകടങ്ങളുടെ ഇൻഷുറൻസ് ആവശ്യങ്ങൾക്കാണ് പ്രധാനമായും ഇത് ഉപയോഗിക്കുന്നത്."
},
lastVerified: "September 2026",
verified: true
},
{
id: "certificate-non-involvement-offences",
category: "documents",
icon: "🛡️",
name: {
en: "Certificate of Non-Involvement in Offences",
ml: "കുറ്റകൃത്യങ്ങളിൽ ഉൾപ്പെട്ടിട്ടില്ലെന്ന സർട്ടിഫിക്കറ്റ്"
},
summary: {
en: "Police verification certificate confirming that no criminal cases or charge sheets exist against the applicant.",
ml: "അപേക്ഷകന്റെ പേരിൽ ക്രിമിനൽ കേസുകളോ കുറ്റകൃത്യങ്ങളോ നിലവിലില്ലെന്ന് പോലീസ് നൽകുന്ന സാക്ഷ്യപത്രം."
},
whoNeeds: {
en: "Candidates joining public sector undertakings, school bus drivers, security guards, and contract employees.",
ml: "ജോലി പ്രവേശനം, സ്കൂൾ ബസ് ഡ്രൈവർമാർ, സ്വകാര്യ സുരക്ഷാ ജീവനക്കാർ എന്നിവർക്കായി തൊഴിലുടമകൾ ആവശ്യപ്പെടുമ്പോൾ."
},
eligibility: {
en: "Residents of Kerala with clean criminal background records.",
ml: "ക്രിമിനൽ കേസുകളിൽ പ്രതിയല്ലാത്ത കേരളത്തിലെ താമസക്കാർ."
},
documents: {
en: [
"Aadhaar Card / Recognized Photo Identity Proof",
"Recent passport-sized photograph",
"Proof of current residential address",
"Employment / requisition letter specifying need for verification"
],
ml: [
"ആധാർ / തിരിച്ചറിയൽ രേഖ",
"പാസ്‌പോർട്ട് സൈസ് ഫോട്ടോ",
"നിലവിലെ താമസസ്ഥലം തെളിയിക്കുന്ന രേഖ",
"സ്ഥാപനത്തിന്റെ ശുപാർശ കത്ത് / അപേക്ഷ"
]
},
additionalDocs: {
en: [
"Court acquittal judgment if previously named in a dismissed case"
],
ml: [
"പഴയ കേസുകളിൽ കുറ്റവിമുക്തനാക്കപ്പെട്ടതാണെങ്കിൽ കോടതി വിധി പകർപ്പ്"
]
},
whereToApply: {
en: "Kerala Police Thuna Portal (thuna.keralapolice.gov.in) or District Police Chief office.",
ml: "കേരള പോലീസ് തുണ പോർട്ടൽ അല്ലെങ്കിൽ ജില്ലാ പോലീസ് ഓഫീസ്."
},
mode: {
en: "Online Portal & Police Station Verification",
ml: "ഓൺലൈൻ അപേക്ഷ & പോലീസ് അന്വേഷണം"
},
steps: {
en: [
"Register on Thuna portal and submit application under verification services.",
"Pay government scrutiny fee online.",
"Jurisdictional Special Branch / local police station conducts background verification.",
"Digitally signed certificate is issued by the District Police Chief."
],
ml: [
"തുണ പോർട്ടൽ വഴി ഫീസ് അടച്ച് അപേക്ഷിക്കുക.",
"ലോക്കൽ പോലീസ് സ്റ്റേഷൻ രേഖകൾ പരിശോധിക്കുന്നു.",
"ജില്ലാ പോലീസ് മേധാവി ഒപ്പിട്ട ഡിജിറ്റൽ സർട്ടിഫിക്കറ്റ് പോർട്ടൽ വഴി ലഭ്യമാകും."
]
},
officialUrl: "https://thuna.keralapolice.gov.in",
notes: {
en: "For overseas emigration or foreign visa purposes, apply for an MEA Police Clearance Certificate (PCC) via Passport Seva Kendra.",
ml: "വിദേശ വിസ ആവശ്യങ്ങൾക്ക് പാസ്‌പോർട്ട് സേവാ കേന്ദ്രം വഴിയുള്ള പി.സി.സി തന്നെയാണ് ഉപയോഗിക്കേണ്ടത്."
},
lastVerified: "September 2026",
verified: true
},
...
ml: "കെട്ടിടത്തിന്റെ പ്രായ സർട്ടിഫിക്കറ്റ്"
},
summary: {
en: "Local body certification stating the constructed age and historical assessment year of a building.",
ml: "ഒരു കെട്ടിടം നിർമ്മിച്ച വർഷവും അതിന്റെ പഴക്കവും തദ്ദേശ സ്ഥാപനം സാക്ഷ്യപ്പെടുത്തുന്ന രേഖ."
},
whoNeeds: {
en: "Property sellers, buyers, banks calculating building depreciation for loans, or demolition approvals.",
ml: "ബാങ്ക് വായ്പകൾ, കെട്ടിട മൂല്യനിർണ്ണയം, പഴയ കെട്ടിടങ്ങൾ പൊളിച്ചുമാറ്റാനുള്ള അനുമതി എന്നിവയ്ക്കായി."
},
eligibility: {
en: "Owners of assessed buildings within the limits of a Kerala Grama Panchayat, Municipality, or Corporation.",
ml: "തദ്ദേശ സ്ഥാപനത്തിൽ നികുതി അടച്ച് വരുന്ന കെട്ടിട ഉടമകൾ."
},
documents: {
en: [
"Building Door Number and Assessment Number",
"Latest Property / Building Tax Receipt",
"Title Deed copy of the land",
"Applicant Aadhaar / ID proof"
],
ml: [
"കെട്ടിട നമ്പർ, വാർഡ് നമ്പർ",
"നടപ്പു വർഷത്തെ കെട്ടിട നികുതി രസീത്",
"ആധാരത്തിന്റെ പകർപ്പ്",
"ആധാർ / തിരിച്ചറിയൽ രേഖ"
]
},
additionalDocs: {
en: [
"Original building permit or completion plan extract from municipal records (if available)"
],
ml: [
"പഴയ പെർമിറ്റ് അല്ലെങ്കിൽ പ്ലാൻ പകർപ്പ് (ലഭ്യമെങ്കിൽ)"
]
},
whereToApply: {
en: "K-SMART portal (for Municipalities/Corporations) or local Grama Panchayat Office.",
ml: "കെ-സ്മാർട്ട് പോർട്ടൽ അല്ലെങ്കിൽ ബന്ധപ്പെട്ട പഞ്ചായത്ത് ഓഫീസ്."
},
mode: {
en: "Online & Local Body Verification",
ml: "ഓൺലൈൻ & തദ്ദേശ ഓഫീസ്"
},
steps: {
en: [
"Submit request on local body portal with building tax assessment details.",
"Revenue Overseer / Assistant Engineer inspects municipal assessment registers to identify first year of assessment.",
"Secretary sanctions certificate confirming constructed age.",
"Download or collect signed certificate."
],
ml: [
"കെട്ടിട നികുതി രസീത് വിവരങ്ങൾ നൽകി അപേക്ഷിക്കുക.",
"തദ്ദേശ സ്ഥാപന രേഖകൾ പരിശോധിച്ച് ആദ്യ നികുതി നിർണ്ണയ വർഷം തിട്ടപ്പെടുത്തുന്നു.",
"സെക്രട്ടറി സാക്ഷ്യപ്പെടുത്തിയ സർട്ടിഫിക്കറ്റ് ലഭ്യമാകുന്നു."
]
},
officialUrl: "https://ksmart.lsgkerala.gov.in",
notes: {
en: "The certified age is calculated based on the year of initial assessment in municipal property tax registers.",
ml: "തദ്ദേശ സ്ഥാപന നികുതി രജിസ്റ്ററിൽ കെട്ടിടം ഉൾപ്പെടുത്തിയ ആദ്യ വർഷത്തെ അടിസ്ഥാനമാക്കിയാണ് പ്രായം കണക്കാക്കുന്നത്."
},
lastVerified: "September 2026",
verified: true
},
...
name: {
en: "BPL Certificate",
ml: "BPL സർട്ടിഫിക്കറ്റ്"
},
summary: {
en: "Certifies that a household is registered under the Below Poverty Line (BPL) socio-economic category.",
ml: "ഒരു കുടുംബം ദാരിദ്ര്യരേഖയ്ക്ക് താഴെയുള്ള (BPL) വിഭാഗത്തിൽ ഉൾപ്പെട്ടതാണെന്ന് തെളിയിക്കുന്ന സാക്ഷ്യപത്രം."
},
whoNeeds: {
en: "Beneficiaries applying for medical fee concessions, free treatment under Karunya (KASP), or educational subsidies.",
ml: "സൗജന്യ ചികിത്സാ പദ്ധതികൾ, ഫീസ് ഇളവുകൾ, മറ്റ് സർക്കാർ ക്ഷേമ പദ്ധതികൾ എന്നിവയ്ക്ക് അപേക്ഷിക്കുന്ന കുടുംബങ്ങൾ."
},
eligibility: {
en: "Households holding active Yellow (AAY) or Pink (PHH) priority ration cards issued by Kerala Civil Supplies.",
ml: "മഞ്ഞ (AAY) അല്ലെങ്കിൽ പിങ്ക് (PHH) മുൻഗണനാ റേഷൻ കാർഡുകൾ ഉള്ള കുടുംബങ്ങൾ."
},
documents: {
en: [
"Copy of Priority Ration Card (Yellow / Pink card showing BPL status)",
"Aadhaar cards of family members",
"Residential electricity bill / Address proof",
"Self-declaration statement"
],
ml: [
"മുൻഗണനാ റേഷൻ കാർഡ് പകർപ്പ് (മഞ്ഞ അല്ലെങ്കിൽ പിങ്ക് കാർഡ്)",
...
additionalDocs: {
en: [
"Certificate from Block Panchayat / Municipal Urban Poverty Alleviation cell if registered in local BPL survey"
],
ml: [
"തദ്ദേശ സ്വയംഭരണ സ്ഥാപനങ്ങളിൽ നിന്നുള്ള ബി.പി.എൽ ലിസ്റ്റ് പകർപ്പ് (ആവശ്യമെങ്കിൽ)"
]
},
whereToApply: {
en: "Grama Panchayat / Municipality Secretary office, or local Village Office via e-District.",
ml: "തദ്ദേശ സ്ഥാപന സെക്രട്ടറി ഓഫീസ് അല്ലെങ്കിൽ ഇ-ഡിസ്ട്രിക്റ്റ് വഴി വില്ലേജ് ഓഫീസ്."
},
mode: {
en: "Online & Local Body Office",
ml: "ഓൺലൈൻ & തദ്ദേശ ഓഫീസ്"
...
steps: {
en: [
"Submit application attaching valid priority ration card and family identity proofs.",
"Authorities cross-verify applicant household with Civil Supplies priority database.",
"Competent officer signs and issues BPL verification certificate.",
"Collect copy for medical or academic submission."
],
ml: [
"റേഷൻ കാർഡ് വിവരങ്ങൾ സഹിതം അപേക്ഷിക്കുക.",
"സിവിൽ സപ്ലൈസ് മുൻഗണനാ പട്ടിക പരിശോധിക്കുന്നു.",
"സാക്ഷ്യപത്രം ലഭ്യമാക്കുന്നു."
]
},
officialUrl: "https://ecitizen.civilsupplieskerala.gov.in",
notes: {
en: "In Kerala, the possession of an active Yellow or Pink priority ration card serves as primary evidence of BPL status.",
ml: "കേരളത്തിൽ മഞ്ഞ, പിങ്ക് റേഷൻ കാർഡുകളാണ് ബി.പി.എൽ തെളിവായി പൊതുവെ പരിഗണിക്കുന്നത്."
},
lastVerified: "September 2026",
verified: true
},
{
id: "local-body-birth-registration",
category: "documents",
icon: "👶",
name: {
en: "Local Body Birth Registration",
ml: "തദ്ദേശ സ്ഥാപനത്തിലെ ജനന രജിസ്ട്രേഷൻ"
},
summary: {
en: "Official procedure to register child births and enter the child's formal name in municipal civil registers.",
ml: "കുട്ടിയുടെ ജനനം തദ്ദേശ സ്ഥാപനത്തിൽ ഔദ്യോഗികമായി രജിസ്റ്റർ ചെയ്യുന്നതിനും പേര് ചേർക്കുന്നതിനുമുള്ള നടപടികൾ."
},
whoNeeds: {
en: "Parents of newborns needing legal civil birth entry and inclusion of the child's name.",
ml: "നവജാത ശിശുക്കളുടെ മാതാപിതാക്കൾ (ജനനം രജിസ്റ്റർ ചെയ്യാനും പേര് രേഖപ്പെടുത്താനും)."
},
eligibility: {
en: "Births occurring within the geographical jurisdiction of the concerned Kerala Panchayat, Municipality, or Corporation.",
ml: "നിശ്ചിത തദ്ദേശ സ്ഥാപന പരിധിയിൽ ജനിച്ച കുട്ടികൾക്ക്."
},
documents: {
en: [
"Hospital Birth Reporting Form (Form 1)",
"Parents' Aadhaar / Identity Proofs",
"Parents' Marriage Certificate",
"Prescribed child naming application form signed by both parents"
],
ml: [
"ആശുപത്രിയിൽ നിന്നുള്ള ജനന വിവര ഫോറം (ഫോം 1)",
"മാതാപിതാക്കളുടെ ആധാർ / തിരിച്ചറിയൽ രേഖകൾ",
"മാതാപിതാക്കളുടെ വിവാഹ സർട്ടിഫിക്കറ്റ്",
"മാതാപിതാക്കൾ ഒപ്പിട്ട പേര് ചേർക്കൽ അപേക്ഷ"
]
},
additionalDocs: {
en: [
"Non-availability certificate and delayed order from RDO if applying after 1 year"
],
ml: [
"ഒരു വർഷത്തിന് ശേഷമാണെങ്കിൽ ആർ.ഡി.ഒ അനുമതി ഉത്തരവ്"
]
},
whereToApply: {
en: "Sevana Civil Registrations portal (cr.lsgkerala.gov.in) or local Panchayat/Municipality Registrar of Births.",
ml: "സെവന പോർട്ടൽ അല്ലെങ്കിൽ തദ്ദേശ സ്ഥാപന ജനന-മരണ രജിസ്ട്രാർ ഓഫീസ്."
},
mode: {
en: "Online (Sevana) & Local Body Office",
ml: "ഓൺലൈൻ & തദ്ദേശ ഓഫീസ്"
},
steps: {
en: [
"Institutional hospital transmits birth event directly to the Sevana portal.",
"Parents apply online or submit Form 1A for child name inclusion within prescribed time.",
"Registrar updates civil record and approves entry.",
"Download legally certified birth certificate with QR code."
],
ml: [
"ആശുപത്രികൾ വഴി ജനനവിവരം സെവന പോർട്ടലിൽ രേഖപ്പെടുത്തുന്നു.",
"കുട്ടിയുടെ പേര് ചേർക്കുന്നതിനായി മാതാപിതാക്കൾ അപേക്ഷിക്കുന്നു.",
"രജിസ്ട്രാർ പരിശോധനയ്ക്ക് ശേഷം ജനന സർട്ടിഫിക്കറ്റ് ലഭ്യമാക്കുന്നു."
]
},
officialUrl: "https://cr.lsgkerala.gov.in",
notes: {
en: "Registering the child's name within 1 year of birth avoids additional verification steps.",
ml: "ജനനം നടന്ന് 1 വർഷത്തിനകം കുട്ടിയുടെ പേര് ചേർക്കുന്നത് നടപടിക്രമങ്ങൾ ലളിതമാക്കും."
},
lastVerified: "September 2026",
verified: true
},
...
{
id: "survey-correction-lrm",
category: "government",
icon: "📐",
name: {
en: "Survey Correction / LRM Services",
ml: "സർവേ തിരുത്തൽ സേവനങ്ങൾ"
},
summary: {
en: "Correction of land survey errors, boundary mismatches, and Land Records Maintenance (LRM) updates in village records.",
ml: "റവന്യൂ വില്ലേജ് രേഖകളിലെ സർവേ നമ്പർ, വിസ്തീർണ്ണം, അതിർത്തി എന്നിവയിലെ പൊരുത്തക്കേടുകൾ തിരുത്തുന്നതിനുള്ള സേവനം."
},
whoNeeds: {
en: "Landowners whose land area or survey number in the title deed does not match the village Basic Tax Register (BTR) or survey sketch.",
ml: "പ്രമാണത്തിലെയും വില്ലേജ് രേഖകളിലെയും സർവേ നമ്പറിലോ വിസ്തീർണ്ണത്തിലോ വ്യത്യാസമുള്ള വസ്തു ഉടമസ്ഥർ."
},
eligibility: {
en: "Lawful title deed holders in Kerala possessing registered land with verified tax remittance history.",
ml: "കേരളത്തിൽ സ്വന്തം പേരിൽ വസ്തു രജിസ്റ്റർ ചെയ്ത, കരം അടയ്ക്കുന്ന ഭൂവുടമകൾ."
},
documents: {
en: [
"Registered Title Deed (Aadhaaram) and prior deeds",
"Latest Land Tax Receipt",
"Possession Certificate and Location Sketch",
"Survey settlement register or Field Measurement Book (FMB) copy",
"Aadhaar / Photo ID proof"
],
ml: [
"രജിസ്റ്റർ ചെയ്ത ആധാരവും മുന്നാധാരങ്ങളും",
"നടപ്പു വർഷത്തെ ഭൂനികുതി രസീത്",
"കൈവശാവകാശ സർട്ടിഫിക്കറ്റും ലൊക്കേഷൻ സ്കെച്ചും",
"എഫ്.എം.ബി (FMB) സ്കെച്ച് പകർപ്പ്",
"ആധാർ / തിരിച്ചറിയൽ രേഖ"
]
},
additionalDocs: {
en: [
"Adjoining plot owners' consent or presence confirmation for boundary re-survey"
],
ml: [
"അതിർത്തി പുനർനിർണ്ണയത്തിനായുള്ള അയൽവാസികളുടെ സാന്നിധ്യം / സമ്മതപത്രം"
]
},
whereToApply: {
en: "Revenue Department Portal (revenue.kerala.gov.in) or Taluk Suvidha / Taluk Surveyor / Tahsildar (LR).",
ml: "റവന്യൂ പോർട്ടൽ അല്ലെങ്കിൽ താലൂക്ക് ഓഫീസ് (തഹസിൽദാർ - എൽ.ആർ / സർവേയർ)."
},
mode: {
en: "Online Application & Field Survey",
ml: "ഓൺലൈൻ അപേക്ഷ & നേരിട്ടുള്ള സർവേ പരിശോധന"
},
steps: {
en: [
"Submit LRM petition online or at Taluk Office attaching title deeds and sketch.",
"Taluk Surveyor visits the plot, surveys boundaries, and prepares comparison report with old records.",
"Tahsildar (Land Records) reviews survey findings and approves correction.",
"Village Officer updates Basic Tax Register (BTR) and issues corrected records."
],
ml: [
"രേഖകൾ സഹിതം താലൂക്ക് ഓഫീസിലോ പോർട്ടലിലോ സർവേ തിരുത്തൽ അപേക്ഷ നൽകുക.",
"താലൂക്ക് സർവേയർ സ്ഥലം സന്ദർശിച്ച് അതിരുകൾ അളന്ന് തിട്ടപ്പെടുത്തുന്നു.",
"തഹസിൽദാർ (എൽ.ആർ) പരിശോധിച്ച് അംഗീകാരം നൽകുന്നു.",
"വില്ലേജ് രേഖകളിൽ ആവശ്യമായ തിരുത്തലുകൾ വരുത്തുന്നു."
]
},
officialUrl: "https://revenue.kerala.gov.in",
notes: {
en: "Disputed boundary issues involving civil title suits must be adjudicated in competent civil courts before survey updates.",
ml: "അതിർത്തി തർക്കങ്ങൾ സിവിൽ കോടതികളുടെ പരിഗണനയിലാണെങ്കിൽ സർവേ തിരുത്തൽ നടപടികൾ തടസ്സപ്പെട്ടേക്കാം."
},
lastVerified: "September 2026",
verified: true
},
{
id: "online-pokkuvaravu-pv",
category: "government",
icon: "🔄",
name: {
en: "Online Pokkuvaravu / PV Services",
ml: "ഓൺലൈൻ പോക്കുവരവ് സേവനങ്ങൾ"
},
summary: {
en: "End-to-end electronic mutation of land ownership (Pokkuvaravu) to transfer title in revenue village records.",
ml: "സ്ഥലം വാങ്ങിയ ശേഷമോ അവകാശമായി ലഭിച്ച ശേഷമോ വില്ലേജ് രേഖകളിൽ പേര് മാറ്റുന്നതിനുള്ള ഓൺലൈൻ പോക്കുവരവ് സേവനം."
},
whoNeeds: {
en: "Buyers, gift recipients, or legal heirs needing their names entered into village Thandaper records to pay land tax in their own name.",
ml: "വസ്തു വാങ്ങിയവരോ അവകാശമായി ലഭിച്ചവരോ സ്വന്തം പേരിൽ കരം ഒടുക്കുന്നതിനായി പോക്കുവരവ് ചെയ്യേണ്ടവർ."
},
eligibility: {
en: "Registered owners whose deed transfer has been registered at the Sub-Registrar Office.",
ml: "സബ് രജിസ്ട്രാർ ഓഫീസിൽ രജിസ്ട്രേഷൻ പൂർത്തിയായ ഭൂവുടമകൾ."
},
documents: {
en: [
"Registered Title Deed copy (with SRO Registration Number & Year)",
"Prior title deed (Munaadhaaram) details",
"Previous owner's land tax receipt / Thandaper number",
"Encumbrance Certificate (EC)"
],
ml: [
"രജിസ്റ്റർ ചെയ്ത ആധാരത്തിന്റെ പകർപ്പ് (SRO നമ്പർ ഉൾപ്പെടെ)",
"മുന്നാധാര വിവരങ്ങൾ",
"മുൻ ഉടമയുടെ നികുതി രസീത് / താണ്ഡപ്പേര്",
"ബാധ്യതാ സർട്ടിഫിക്കറ്റ് (EC)"
]
},
additionalDocs: {
en: [
"Legal heirship certificate / Partition deed extract (for inheritance transfers)"
],
ml: [
"അനന്തരാവകാശ സർട്ടിഫിക്കറ്റ് / ഭാഗപത്രം (അവകാശ കൈമാറ്റങ്ങൾക്ക്)"
]
},
whereToApply: {
en: "Kerala Revenue Department Portal (revenue.kerala.gov.in) via PEARL integrated workflow.",
ml: "റവന്യൂ പോർട്ടൽ (revenue.kerala.gov.in) അല്ലെങ്കിൽ വില്ലേജ് ഓഫീസ്."
},
mode: {
en: "100% Online",
ml: "പൂർണ്ണമായും ഓൺലൈൻ"
...
steps: {
en: [
"SRO registration triggers electronic mutation request automatically, or citizen logs in to Revenue Portal.",
"Input document details and select concerned revenue village.",
"Village Officer scrutinizes title flow and conducts online verification.",
"Mutation is sanctioned, new Thandaper is created, and citizen pays tax online."
],
ml: [
"രജിസ്ട്രേഷൻ സമയത്ത് തന്നെ പോക്കുവരവ് അപേക്ഷ സമർപ്പിക്കുകയോ പോർട്ടലിൽ അപേക്ഷിക്കുകയോ ചെയ്യുക.",
"വില്ലേജ് ഓഫീസർ രേഖകൾ പരിശോധിച്ച് അംഗീകാരം നൽകുന്നു.",
"പോക്കുവരവ് പൂർത്തിയായി പുതിയ താണ്ഡപ്പേര് അനുവദിക്കുന്നു.",
"തുടർന്ന് സ്വന്തം പേരിൽ നികുതി അടയ്ക്കാം."
]
},
officialUrl: "https://revenue.kerala.gov.in",
notes: {
en: "Status can be tracked in real-time on revenue.kerala.gov.in using the Document Registration Number.",
ml: "ആധാരത്തിന്റെ രജിസ്ട്രേഷൻ നമ്പർ ഉപയോഗിച്ച് പോക്കുവരവ് സ്റ്റാറ്റസ് ഓൺലൈനായി പരിശോധിക്കാം."
},
lastVerified: "September 2026",
verified: true
},
{
id: "ration-card-member-addition",
category: "government",
icon: "➕",
name: {
en: "Ration Card Member Addition",
ml: "റേഷൻ കാർഡിൽ അംഗത്തെ ചേർക്കൽ"
},
summary: {
en: "Civil Supplies service to include a newborn child, newly married spouse, or family member into an existing ration card.",
ml: "നിലവിലുള്ള റേഷൻ കാർഡിൽ കുട്ടികളെയോ വിവാഹം കഴിഞ്ഞ് വന്ന പങ്കാളിയെയോ പുതിയ അംഗങ്ങളെയോ ചേർക്കുന്നതിനുള്ള സേവനം."
},
whoNeeds: {
en: "Households with newborn children or newly married family members moving into the residence.",
ml: "കുടുംബത്തിൽ പുതിയ കുഞ്ഞ് ജനിച്ചവർ, വിവാഹിതരായി പുതിയ അംഗം എത്തിയവർ."
},
eligibility: {
en: "The person to be added must not be enrolled in any other active ration card in India.",
ml: "ചേർക്കപ്പെടുന്ന വ്യക്തി ഇന്ത്യയിൽ മറ്റൊരു റേഷൻ കാർഡിലും അംഗമായിരിക്കരുത്."
},
documents: {
en: [
"Existing Ration Card copy",
"Aadhaar Card of the member to be added",
"Birth Certificate (for newborn children under 5)",
"Surrender Certificate / Deletion Certificate from previous card (for spouses/migrating members)"
],
ml: [
"നിലവിലുള്ള റേഷൻ കാർഡ് പകർപ്പ്",
"ചേർക്കേണ്ട അംഗത്തിന്റെ ആധാർ കാർഡ്",
"കുട്ടികൾക്കാണെങ്കിൽ ജനന സർട്ടിഫിക്കറ്റ്",
"മറ്റൊരു കാർഡിൽ നിന്നാണെങ്കിൽ പേര് ഒഴിവാക്കിയ സർട്ടിഫിക്കറ്റ് (Deletion Certificate)"
]
},
additionalDocs: {
en: [
"Marriage certificate (recommended for spouse inclusion)"
],
ml: [
"ഭാര്യ/ഭർത്താവിന്റെ പേര് ചേർക്കാൻ വിവാഹ സർട്ടിഫിക്കറ്റ്"
]
...
whereToApply: {
en: "Civil Supplies Citizen Portal (ecitizen.civilsupplieskerala.gov.in) or local Akshaya Centre / TSO.",
ml: "സിവിൽ സപ്ലൈസ് പോർട്ടൽ (ecitizen.civilsupplieskerala.gov.in) അല്ലെങ്കിൽ അക്ഷയ കേന്ദ്രം / TSO."
},
mode: {
en: "Online & Taluk Supply Office",
ml: "ഓൺലൈൻ & താലൂക്ക് സപ്ലൈ ഓഫീസ്"
},
steps: {
en: [
"Log in to Citizen Portal using ration card credentials.",
"Select 'Member Addition' service and enter Aadhaar and demographic details of the new member.",
"Upload Birth Certificate or Deletion Certificate.",
"Taluk Supply Officer / Rationing Inspector approves addition; updated e-card is available for download."
],
ml: [
"സിവിൽ സപ്ലൈസ് പോർട്ടലിൽ റേഷൻ കാർഡ് വിവരങ്ങൾ നൽകി ലോഗിൻ ചെയ്യുക.",
"'Member Addition' തിരഞ്ഞെടുത്ത് ആധാർ വിവരങ്ങളും രേഖകളും നൽകുക.",
"റേഷനിംഗ് ഇൻസ്പെക്ടറുടെ പരിശോധനയ്ക്ക് ശേഷം അപേക്ഷ അംഗീകരിക്കും.",
"പുതുക്കിയ റേഷൻ കാർഡ് ഡൗൺലോഡ് ചെയ്യാം."
]
},
officialUrl: "https://ecitizen.civilsupplieskerala.gov.in",
notes: {
en: "For adults, obtaining a Deletion/Surrender Certificate from their prior ration card is mandatory before applying for addition.",
ml: "മുതിർന്ന വ്യക്തികളെ ചേർക്കുന്നതിന് മുൻപ് അവരുടെ പഴയ കാർഡിൽ നിന്ന് പേര് ഒഴിവാക്കിയ സർട്ടിഫിക്കറ്റ് നിർബന്ധമാണ്."
},
lastVerified: "September 2026",
verified: true
},
...
icon: "📍",
name: {
en: "Ration Card Address Change",
ml: "റേഷൻ കാർഡ് വിലാസം മാറ്റൽ"
},
summary: {
en: "Updating residential address and shifting ration allocation within the same taluk or across different taluks in Kerala.",
ml: "താമസം മാറുമ്പോൾ റേഷൻ കാർഡിലെ മേൽവിലാസം മാറ്റുന്നതിനും അനുയോജ്യമായ റേഷൻ കടയിലേക്ക് മാറ്റുന്നതിനുമുള്ള സേവനം."
},
whoNeeds: {
en: "Families shifting their residence to a new rental house or newly constructed home.",
ml: "വാടകവീട് മാറുകയോ സ്വന്തമായി പുതിയ വീട് വെച്ച് താമസം മാറുകയോ ചെയ്ത കുടുംബങ്ങൾ."
},
eligibility: {
en: "Cardholders permanently or ordinarily residing at the new address in Kerala.",
ml: "കേരളത്തിൽ പുതിയ മേൽവിലാസത്തിൽ താമസിക്കുന്ന റേഷൻ കാർഡ് ഉടമകൾ."
},
documents: {
en: [
"Existing Ration Card",
"Proof of new address (Electricity Bill / Water Bill / Local body Building Tax receipt / Registered Rent Agreement)",
"Aadhaar card of cardhead showing updated address"
],
ml: [
"നിലവിലുള്ള റേഷൻ കാർഡ്",
"പുതിയ മേൽവിലാസം തെളിയിക്കുന്ന വൈദ്യുതി ബിൽ / കെട്ടിട നികുതി രസീത് / വാടകക്കരാർ",
"കുടുംബനാഥന്റെ ആധാർ കാർഡ്"
]
},
additionalDocs: {
en: [
"Certificate from local Ward Member / Councillor confirming new dwelling (if rental agreement unavailable)"
],
ml: [
"വാർഡ് മെമ്പർ / കൗൺസിലറുടെ സാക്ഷ്യപത്രം (ആവശ്യമെങ്കിൽ)"
]
},
whereToApply: {
en: "Civil Supplies Citizen Portal (ecitizen.civilsupplieskerala.gov.in) or Akshaya Centre.",
ml: "സിവിൽ സപ്ലൈസ് പോർട്ടൽ അല്ലെങ്കിൽ അക്ഷയ കേന്ദ്രം / TSO."
},
mode: {
en: "Online & Taluk Supply Office",
ml: "ഓൺലൈൻ & താലൂക്ക് സപ്ലൈ ഓഫീസ്"
...
steps: {
en: [
"Log in on ecitizen portal and select 'Change of Address'.",
"Choose new Taluk, Village, and preferred ARD (Authorized Ration Dealer) shop.",
"Upload new address proof.",
"Rationing Inspector verifies local residence; updated card with new ARD assignment is generated."
],
ml: [
"പോർട്ടലിൽ ലോഗിൻ ചെയ്ത് 'Change of Address' തിരഞ്ഞെടുക്കുക.",
"പുതിയ താലൂക്ക്, വില്ലേജ്, അടുത്തുള്ള റേഷൻ കട എന്നിവ തിരഞ്ഞെടുക്കുക.",
"മേൽവിലാസ രേഖ അപ്‌ലോഡ് ചെയ്യുക.",
"പരിശോധനയ്ക്ക് ശേഷം പുതിയ വിലാസത്തിലുള്ള കാർഡ് ലഭ്യമാകും."
]
},
officialUrl: "https://ecitizen.civilsupplieskerala.gov.in",
notes: {
en: "If shifting to another Taluk, the application requires approval from both the releasing and receiving Taluk Supply Offices.",
ml: "മറ്റൊരു താലൂക്കിലേക്കാണ് മാറ്റമെങ്കിൽ ഇരു താലൂക്ക് സപ്ലൈ ഓഫീസുകളുടെയും അനുമതി ആവശ്യമായി വരും."
},
lastVerified: "September 2026",
verified: true
},
...
icon: "✏️",
name: {
en: "Ration Card Name & Demographic Correction",
ml: "റേഷൻ കാർഡ് പേര് തിരുത്തൽ"
},
summary: {
en: "Correction of spelling mistakes in cardholder names, age, gender, or relationship entries in ration cards.",
ml: "റേഷൻ കാർഡിലെ പേര്, പ്രായം, ലിംഗം, കുടുംബനാഥനുമായുള്ള ബന്ധം എന്നിവയിലെ തെറ്റുകൾ തിരുത്തുന്നതിനുള്ള സേവനം."
},
whoNeeds: {
en: "Individuals whose ration card details mismatch with Aadhaar or educational certificates.",
ml: "റേഷൻ കാർഡിലെ പേരുകളിലും വിവരങ്ങളിലും അക്ഷരത്തെറ്റുകളോ വ്യത്യാസങ്ങളോ ഉള്ള വ്യക്തികൾ."
},
eligibility: {
en: "Any active ration card beneficiary registered under Kerala Civil Supplies.",
ml: "കേരളത്തിലെ നിലവിലുള്ള റേഷൻ കാർഡുകളിൽ ഉൾപ്പെട്ടിട്ടുള്ള അംഗങ്ങൾക്ക്."
},
documents: {
en: [
"Copy of existing Ration Card",
"Aadhaar Card of the person whose name/details need correction",
"Supporting proof with correct name (SSLC, Birth Certificate, Voter ID, or Passport)"
],
ml: [
"നിലവിലുള്ള റേഷൻ കാർഡ് പകർപ്പ്",
"തിരുത്തൽ ആവശ്യമുള്ള വ്യക്തിയുടെ ആധാർ കാർഡ്",
"ശരിയായ പേര് രേഖപ്പെടുത്തിയ SSLC, ജനന സർട്ടിഫിക്കറ്റ് മുതലായവ"
]
},
additionalDocs: {
en: [
"Gazette notification copy (if official name change has been published)"
],
ml: [
"ഗസറ്റ് വിജ്ഞാപന പകർപ്പ് (ഔദ്യോഗികമായി പേര് മാറ്റിയതാണെങ്കിൽ)"
]
},
whereToApply: {
en: "Civil Supplies Citizen Portal (ecitizen.civilsupplieskerala.gov.in) or Akshaya Centre.",
ml: "സിവിൽ സപ്ലൈസ് പോർട്ടൽ അല്ലെങ്കിൽ അക്ഷയ കേന്ദ്രം."
},
mode: {
en: "Online & TSO",
ml: "ഓൺലൈൻ & താലൂക്ക് സപ്ലൈ ഓഫീസ്"
...
steps: {
en: [
"Log in on ecitizen portal and select 'Card Correction / Name Correction'.",
"Edit misspelled fields to match the primary identity document.",
"Upload scanned copy of Aadhaar or supporting certificate.",
"TSO clerk verifies demographic parity and approves changes."
],
ml: [
"സിവിൽ സപ്ലൈസ് പോർട്ടലിൽ 'Card Correction' തിരഞ്ഞെടുക്കുക.",
"തെറ്റായ വിവരങ്ങൾ തിരുത്തി ശരിയായ രേഖകൾ അപ്‌ലോഡ് ചെയ്യുക.",
"ടി.എസ്.ഒ പരിശോധനയ്ക്ക് ശേഷം തിരുത്തലുകൾ നിലവിൽ വരും."
]
},
officialUrl: "https://ecitizen.civilsupplieskerala.gov.in",
notes: {
en: "Aadhaar e-KYC integration allows instant correction if Aadhaar details are already accurate.",
ml: "ആധാർ ഇ-കെവൈസി വഴി വളരെ വേഗത്തിൽ കൃത്യമായ വിവരങ്ങൾ കാർഡിൽ അപ്‌ഡേറ്റ് ചെയ്യാൻ സാധിക്കും."
},
lastVerified: "September 2026",
verified: true
},
{
id: "ration-card-member-reduction",
category: "government",
icon: "➖",
name: {
en: "Ration Card Member Reduction / Deletion",
ml: "റേഷൻ കാർഡിൽ നിന്ന് അംഗത്തെ ഒഴിവാക്കൽ"
},
summary: {
en: "Removing a deceased family member or an individual moving out to another household or state.",
ml: "മരണപ്പെട്ട അംഗങ്ങളെയോ വിവാഹം കഴിഞ്ഞ് മറ്റ് വീടുകളിലേക്ക് മാറിയവരെയോ റേഷൻ കാർഡിൽ നിന്ന് ഒഴിവാക്കുന്നതിനുള്ള സേവനം."
},
whoNeeds: {
en: "Households updating member counts after the death of a member or after marriage/relocation.",
ml: "കുടുംബാംഗം മരണപ്പെടുകയോ വിവാഹം കഴിഞ്ഞ് മറ്റൊരു കാർഡിലേക്ക് പേര് മാറ്റേണ്ടി വരികയോ ചെയ്യുന്നവർ."
},
eligibility: {
en: "Head of family or member registered in an active Kerala ration card.",
ml: "റേഷൻ കാർഡിൽ നിലവിൽ പേരുള്ള കുടുംബാംഗങ്ങൾക്ക്."
},
documents: {
en: [
"Copy of existing Ration Card",
"Death Certificate (if removing deceased member)",
"Marriage Certificate or Marriage invitation card (if removing due to marriage)",
"Aadhaar card of the applicant"
],
ml: [
"നിലവിലുള്ള റേഷൻ കാർഡ് പകർപ്പ്",
"മരണപ്പെട്ടയാളെ ഒഴിവാക്കാനാണെങ്കിൽ മരണ സർട്ടിഫിക്കറ്റ്",
"വിവാഹം മൂലമാണെങ്കിൽ വിവാഹ സർട്ടിഫിക്കറ്റ് അല്ലെങ്കിൽ ക്ഷണക്കത്ത്",
"അപേക്ഷകന്റെ ആധാർ കാർഡ്"
]
},
additionalDocs: {
en: [
"Application requesting Deletion/Reduction Certificate for joining another ration card"
],
ml: [
"മറ്റൊരു കാർഡിൽ ചേരുന്നതിനായി ഡിലീഷൻ സർട്ടിഫിക്കറ്റ് ആവശ്യപ്പെട്ടുകൊണ്ടുള്ള അപേക്ഷ"
]
},
whereToApply: {
en: "Civil Supplies Citizen Portal (ecitizen.civilsupplieskerala.gov.in) or Akshaya Centre / TSO.",
ml: "സിവിൽ സപ്ലൈസ് പോർട്ടൽ അല്ലെങ്കിൽ അക്ഷയ കേന്ദ്രം / TSO."
},
mode: {
en: "Online & TSO",
...
steps: {
en: [
"Log in on ecitizen portal and choose 'Member Reduction'.",
"Select specific member to be removed and choose reason (Death / Marriage / Relocation).",
"Upload Death Certificate or Marriage proof.",
"TSO approves request; download official Reduction/Deletion Certificate."
],
ml: [
"പോർട്ടലിൽ ലോഗിൻ ചെയ്ത് 'Member Reduction' തിരഞ്ഞെടുക്കുക.",
"ഒഴിവാക്കേണ്ട അംഗത്തെയും കാരണം (മരണം/വിവാഹം) തിരഞ്ഞെടുക്കുക.",
"രേഖകൾ അപ്‌ലോഡ് ചെയ്ത് സമർപ്പിക്കുക.",
"അംഗീകാരം ലഭിച്ച ശേഷം ഡിലീഷൻ സർട്ടിഫിക്കറ്റ് ഡൗൺലോഡ് ചെയ്യാം."
]
},
officialUrl: "https://ecitizen.civilsupplieskerala.gov.in",
notes: {
en: "The issued Deletion Certificate is mandatory to add that member to their new spouse's or family's ration card.",
ml: "മറ്റൊരു റേഷൻ കാർഡിൽ പേര് ചേർക്കുന്നതിനായി ഈ ഡിലീഷൻ സർട്ടിഫിക്കറ്റ് അത്യാവശ്യമാണ്."
},
lastVerified: "September 2026",
verified: true
},
...
ml: "റേഷൻ കാർഡ് മാറ്റം"
},
summary: {
en: "Complete transfer of entire ration card file to another Taluk Supply Office or rationing jurisdiction.",
ml: "മുഴുവൻ കുടുംബവും മറ്റൊരു താലൂക്കിലേക്ക് സ്ഥിരമായി താമസം മാറുമ്പോൾ റേഷൻ കാർഡ് പൂർണ്ണമായി മാറ്റുന്ന സേവനം."
},
whoNeeds: {
en: "Entire families moving permanently from one taluk or district to another in Kerala.",
ml: "ഒരു താലൂക്കിൽ നിന്നും മറ്റൊരു താലൂക്കിലേക്ക് കുടുംബസമേതം താമസം മാറുന്നവർ."
},
eligibility: {
en: "Existing valid ration cardholder families with physical residency established in the new jurisdiction.",
ml: "പുതിയ താലൂക്ക് പരിധിയിലേക്ക് മാറിയ നിലവിലുള്ള റേഷൻ കാർഡ് ഉടമകൾ."
},
documents: {
en: [
"Original Ration Card",
"Address proof at new location (Building Tax Receipt, Electricity Bill, Rental Agreement)",
"Aadhaar cards of family members",
"Written transfer application"
],
ml: [
"നിലവിലുള്ള റേഷൻ കാർഡ്",
"പുതിയ സ്ഥലത്തെ മേൽവിലാസ രേഖ (കെട്ടിട നികുതി രസീത് / കറന്റ് ബിൽ / വാടകക്കരാർ)",
"കുടുംബാംഗങ്ങളുടെ ആധാർ കാർഡുകൾ",
"സ്ഥലംമാറ്റ അപേക്ഷ"
]
},
additionalDocs: {
en: [
"Surrender/NOC certificate from existing Taluk Supply Office (if processed offline)"
],
ml: [
"പഴയ താലൂക്ക് സപ്ലൈ ഓഫീസിൽ നിന്നുള്ള എൻ.ഒ.സി (ഓഫ്‌ലൈൻ വഴിയാണെങ്കിൽ)"
]
},
whereToApply: {
en: "Civil Supplies Citizen Portal (ecitizen.civilsupplieskerala.gov.in) or concerned TSO offices.",
ml: "സിവിൽ സപ്ലൈസ് പോർട്ടൽ അല്ലെങ്കിൽ താലൂക്ക് സപ്ലൈ ഓഫീസ്."
},
mode: {
en: "Online & TSO Coordination",
ml: "ഓൺലൈൻ & താലൂക്ക് സപ്ലൈ ഓഫീസ്"
},
steps: {
en: [
"Submit 'Card Transfer' application on the Citizen Portal.",
"Specify destination district, taluk, village, and new ARD ration dealer.",
"Upload new address proof.",
"Origin TSO verifies and transfers electronic docket to destination TSO for final endorsement."
],
ml: [
"പോർട്ടൽ വഴി 'Card Transfer' അപേക്ഷ നൽകുക.",
"പുതിയ ജില്ല, താലൂക്ക്, റേഷൻ കട എന്നിവ തിരഞ്ഞെടുക്കുക.",
"മേൽവിലാസ രേഖ അപ്‌ലോഡ് ചെയ്യുക.",
"ഇരു താലൂക്ക് ഓഫീസുകളുടെയും അനുമതിക്ക് ശേഷം കാർഡ് പുതിയ സ്ഥലത്തേക്ക് മാറ്റപ്പെടും."
]
},
officialUrl: "https://ecitizen.civilsupplieskerala.gov.in",
notes: {
en: "Clear any pending monthly quota allocations before initiating inter-taluk transfer.",
ml: "നടപ്പ് മാസത്തെ റേഷൻ വിഹിതം കൈപ്പറ്റിയ ശേഷമോ മാസാവസാനമോ അപേക്ഷിക്കുന്നതാണ് ഉചിതം."
},
lastVerified: "September 2026",
verified: true
},
{
id: "duplicate-ration-card",
category: "government",
icon: "📄",
name: {
en: "Duplicate Ration Card",
ml: "ഡ്യൂപ്ലിക്കേറ്റ് റേഷൻ കാർഡ്"
},
summary: {
en: "Re-issuance of a lost, damaged, torn, or destroyed physical ration card.",
ml: "റേഷൻ കാർഡ് നഷ്ടപ്പെടുകയോ കേടുപാടുകൾ സംഭവിക്കുകയോ ചെയ്താൽ പുതിയ പകർപ്പ് ലഭ്യമാക്കുന്നതിനുള്ള സേവനം."
},
whoNeeds: {
en: "Cardholders whose physical card is damaged, illegible, or misplaced.",
ml: "റേഷൻ കാർഡ് നഷ്ടപ്പെട്ടവരോ കീറി നശിച്ചുപോയവരോ ആയ കാർഡ് ഉടമകൾ."
},
eligibility: {
en: "Any active ration cardholder in Kerala.",
ml: "കേരളത്തിൽ നിലവിൽ റേഷൻ കാർഡുള്ള എല്ലാ കുടുംബങ്ങൾക്കും."
},
documents: {
en: [
"Ration Card Number / Copy of previous card (if available)",
"Aadhaar Card of the Card Head",
"Self-declaration affidavit stating circumstances of loss or damaged card",
"Police lost report acknowledgement (if lost)"
],
ml: [
"റേഷൻ കാർഡ് നമ്പർ / പഴയ കാർഡിന്റെ പകർപ്പ്",
"കുടുംബനാഥന്റെ ആധാർ കാർഡ്",
"കാർഡ് നഷ്ടപ്പെട്ടത് സംബന്ധിച്ച സത്യവാങ്മൂലം",
"പോലീസ് പരാതി രസീത് (നഷ്ടപ്പെട്ടതാണെങ്കിൽ)"
]
},
additionalDocs: {
en: [
"Physical damaged card surrender (if applying for damaged card replacement)"
],
ml: [
"കേടുവന്ന കാർഡിന്റെ അവശിഷ്ടങ്ങൾ (ബാധകമെങ്കിൽ)"
]
},
whereToApply: {
en: "Civil Supplies Citizen Portal (ecitizen.civilsupplieskerala.gov.in) or Akshaya Centre / TSO.",
...
mode: {
en: "Online & TSO Counter",
ml: "ഓൺലൈൻ & താലൂക്ക് സപ്ലൈ ഓഫീസ്"
},
steps: {
en: [
"Log in on ecitizen portal and choose 'Duplicate Card'.",
"Enter card details and state reason for duplication.",
"Pay statutory government fee online.",
"Download digital e-card instantly or receive physical booklet from TSO."
],
ml: [
"സിവിൽ സപ്ലൈസ് പോർട്ടലിൽ 'Duplicate Card' തിരഞ്ഞെടുക്കുക.",
"കാരണം വ്യക്തമാക്കി രേഖകൾ നൽകുക.",
"നിശ്ചിത സർക്കാർ ഫീസ് ഓൺലൈനായി അടയ്ക്കുക.",
"ഇ-റേഷൻ കാർഡ് ഓൺലൈനായി ഡൗൺലോഡ് ചെയ്ത് പ്രിന്റ് എടുക്കാം."
]
},
officialUrl: "https://ecitizen.civilsupplieskerala.gov.in",
notes: {
en: "The downloadable e-Ration Card carries official digital signature and QR code and is legally valid across all public offices.",
ml: "പോർട്ടലിൽ നിന്ന് ഡൗൺലോഡ് ചെയ്യുന്ന ക്യു.ആർ കോഡുള്ള ഇ-റേഷൻ കാർഡ് എല്ലാ ആവശ്യങ്ങൾക്കും സാധുവാണ്."
},
lastVerified: "September 2026",
verified: true
},
...
icon: "📤",
name: {
en: "Ration Card Surrender",
ml: "റേഷൻ കാർഡ് സറണ്ടർ"
},
summary: {
en: "Formal surrender of an entire ration card upon leaving Kerala permanently or obtaining overseas citizenship.",
ml: "കേരളത്തിന് പുറത്തേക്ക് സ്ഥിരമായി താമസം മാറുകയോ വിദേശ പൗരത്വം നേടുകയോ ചെയ്യുമ്പോൾ റേഷൻ കാർഡ് പൂർണ്ണമായി റദ്ദാക്കുന്ന സേവനം."
},
whoNeeds: {
en: "Families moving outside Kerala permanently or applying for new ration cards in other Indian states.",
ml: "മറ്റ് സംസ്ഥാനങ്ങളിലേക്ക് സ്ഥിരമായി മാറുന്നവർ അല്ലെങ്കിൽ കാർഡ് ആവശ്യമില്ലാത്തവർ."
},
eligibility: {
en: "Registered cardholders intending to cancel their state ration quota.",
ml: "കേരളത്തിലെ റേഷൻ കാർഡ് ഔദ്യോഗികമായി റദ്ദാക്കാൻ ആഗ്രഹിക്കുന്ന കാർഡ് ഉടമകൾ."
},
documents: {
en: [
"Original Ration Card",
"Aadhaar card of cardholder",
"Proof of relocation (Employment transfer letter, interstate residence proof, or written request)",
"Clearance of all grain quota obligations"
],
ml: [
"ഒറിജിനൽ റേഷൻ കാർഡ്",
"കുടുംബനാഥന്റെ ആധാർ കാർഡ്",
"മറ്റ് സ്ഥലത്തേക്ക് മാറുന്നുവെന്ന് തെളിയിക്കുന്ന രേഖ / അപേക്ഷ",
"റേഷൻ കുടിശ്ശികയില്ലെന്ന സാക്ഷ്യപ്പെടുത്തൽ"
]
},
additionalDocs: {
en: [
"Passport / foreign residence document (if settling abroad permanently)"
],
ml: [
"വിദേശത്തേക്ക് സ്ഥിരതാമസത്തിന് പോകുന്നവരാണെങ്കിൽ പാസ്‌പോർട്ട് പകർപ്പ്"
]
},
whereToApply: {
en: "Civil Supplies Citizen Portal (ecitizen.civilsupplieskerala.gov.in) or jurisdictional Taluk Supply Office.",
ml: "സിവിൽ സപ്ലൈസ് പോർട്ടൽ അല്ലെങ്കിൽ താലൂക്ക് സപ്ലൈ ഓഫീസ് (TSO)."
},
mode: {
en: "Online Application & Card Surrender",
ml: "ഓൺലൈൻ അപേക്ഷ & കാർഡ് സമർപ്പിക്കൽ"
},
steps: {
en: [
"Apply for 'Card Surrender' on the Citizen Portal.",
"Upload written surrender declaration and identity documents.",
"Surrender physical card booklet at TSO counter if demanded.",
"TSO cancels card and issues official Surrender Certificate."
],
ml: [
"പോർട്ടൽ വഴി 'Card Surrender' അപേക്ഷ സമർപ്പിക്കുക.",
"സത്യവാങ്മൂലവും തിരിച്ചറിയൽ രേഖകളും നൽകുക.",
"താലൂക്ക് സപ്ലൈ ഓഫീസിൽ പഴയ കാർഡ് സമർപ്പിക്കുക.",
"റദ്ദാക്കിക്കൊണ്ടുള്ള ഔദ്യോഗിക സറണ്ടർ സർട്ടിഫിക്കറ്റ് കൈപ്പറ്റുക."
]
},
officialUrl: "https://ecitizen.civilsupplieskerala.gov.in",
notes: {
en: "The Surrender Certificate issued by Kerala Civil Supplies is required to apply for a fresh ration card in another state.",
ml: "മറ്റ് സംസ്ഥാനങ്ങളിൽ പുതിയ റേഷൻ കാർഡ് എടുക്കുന്നതിനായി ഈ സറണ്ടർ സർട്ടിഫിക്കറ്റ് ആവശ്യമാണ്."
},
lastVerified: "September 2026",
verified: true
},
{
id: "ration-card-residence-status-change",
category: "government",
icon: "🔄",
name: {
en: "Ration Card Residence Status Change (NRI / Resident)",
ml: "റേഷൻ കാർഡ് താമസസ്ഥിതി മാറ്റം"
},
summary: {
en: "Updating resident status to Non-Resident Indian (NRI) or vice versa in ration card records.",
ml: "റേഷൻ കാർഡിലെ അംഗങ്ങളുടെ പ്രവാസി (NRI) അല്ലെങ്കിൽ സാധാരണ താമസക്കാരൻ എന്ന പദവി മാറ്റുന്നതിനുള്ള സേവനം."
},
whoNeeds: {
en: "Card members moving abroad for employment or returning permanently to Kerala.",
ml: "വിദേശത്ത് ജോലിക്ക് പോകുന്ന പ്രവാസികൾ, പ്രവാസം അവസാനിപ്പിച്ച് നാട്ടിൽ തിരിച്ചെത്തിയവർ."
},
eligibility: {
en: "Any enrolled member in a Kerala ration card holding valid passport/visa records.",
ml: "കേരളത്തിലെ റേഷൻ കാർഡുകളിൽ ഉൾപ്പെട്ടിട്ടുള്ള പ്രവാസികൾ അല്ലെങ്കിൽ മടങ്ങിയെത്തിയവർ."
},
documents: {
en: [
"Existing Ration Card copy",
"Aadhaar card of the member",
"Passport copy with valid work visa / Iqama (for NRI status)",
"Passport arrival stamp / cancelled visa (for returning resident status)"
],
ml: [
"റേഷൻ കാർഡ് പകർപ്പ്",
"അംഗത്തിന്റെ ആധാർ കാർഡ്",
"വിദേശ വിസയുള്ള പാസ്‌പോർട്ട് പകർപ്പ് (NRI പദവിക്ക്)",
"തിരിച്ചെത്തിയ വിവരങ്ങൾ കാണിക്കുന്ന പാസ്‌പോർട്ട് പകർപ്പ് (സാധാരണ പദവിക്ക്)"
]
},
additionalDocs: {
en: [
"Self-declaration on travel and residency duration"
],
ml: [
"താമസ കാലാവധി സംബന്ധിച്ച സ്വയം സാക്ഷ്യപ്പെടുത്തൽ"
]
},
whereToApply: {
en: "Civil Supplies Citizen Portal (ecitizen.civilsupplieskerala.gov.in) or Akshaya Centre.",
...
steps: {
en: [
"Log in on ecitizen portal and select 'Residency Status Change'.",
"Select the family member and choose NRI or Resident status.",
"Upload passport pages showing visa or return stamp.",
"TSO updates Civil Supplies master registry and recalculates household entitlement."
],
ml: [
"പോർട്ടലിൽ 'Residency Status Change' തിരഞ്ഞെടുക്കുക.",
"അംഗത്തെയും മാറ്റേണ്ട പദവിയും (NRI / Resident) തിരഞ്ഞെടുക്കുക.",
"പാസ്‌പോർട്ട് പകർപ്പ് അപ്‌ലോഡ് ചെയ്യുക.",
"ടി.എസ്.ഒ പരിശോധനയ്ക്ക് ശേഷം കാർഡിലെ വിവരങ്ങൾ അപ്‌ഡേറ്റ് ചെയ്യും."
]
},
officialUrl: "https://ecitizen.civilsupplieskerala.gov.in",
notes: {
en: "Members marked as NRI are excluded from foodgrain quota calculations while maintaining family card continuity.",
ml: "എൻ.ആർ.ഐ ആയി രേഖപ്പെടുത്തുന്ന അംഗങ്ങളെ റേഷൻ ഭക്ഷ്യധാന്യ വിഹിതം കണക്കാക്കുന്നതിൽ നിന്ന് ഒഴിവാക്കാറുണ്ട്."
},
lastVerified: "September 2026",
verified: true
},
{
id: "police-complaint-service",
category: "government",
icon: "📝",
name: {
en: "Police Complaint Service",
ml: "പോലീസ് പരാതി സേവനം"
},
summary: {
en: "Online registration of general, cognizable, and non-cognizable complaints directly with Kerala Police.",
ml: "പോലീസ് സ്റ്റേഷനിൽ നേരിട്ട് പോകാതെ പൊതു പരാതികൾ ഓൺലൈനായി സമർപ്പിക്കുന്നതിനുള്ള സംവിധാനം."
},
whoNeeds: {
en: "Citizens seeking inquiry into criminal harassment, neighborhood disputes, financial fraud, or civil disturbances.",
ml: "സാമ്പത്തിക തട്ടിപ്പുകൾ, ശല്യപ്പെടുത്തലുകൾ, മറ്റ് പരാതികൾ എന്നിവ പോലീസിൽ അറിയിക്കാൻ ആഗ്രഹിക്കുന്നവർ."
},
eligibility: {
en: "Any citizen or victim of an offense within the jurisdiction of Kerala State.",
ml: "കേരളത്തിൽ പരാതി സമർപ്പിക്കാൻ ആഗ്രഹിക്കുന്ന ഏതൊരു പൗരനും."
},
documents: {
en: [
"Complainant's Aadhaar / Recognized Photo Identity Proof",
"Mobile number for OTP verification",
"Detailed written petition stating facts, dates, suspect details, and incident location"
],
ml: [
"പരാതിക്കാരന്റെ ആധാർ / തിരിച്ചറിയൽ രേഖ",
"ഒ.ടി.പി ലഭിക്കാനുള്ള മൊബൈൽ നമ്പർ",
"സംഭവം, തീയതി, സ്ഥലം, എതിർകക്ഷിയുടെ വിവരങ്ങൾ എന്നിവ അടങ്ങിയ പരാതി"
]
},
additionalDocs: {
en: [
"Audio/video proof, bank transaction slips, screenshots, or medical wound certificates"
],
ml: [
"ബാങ്ക് ഇടപാട് രസീതുകൾ, ഫോട്ടോകൾ, മറ്റ് തെളിവുകൾ (ബാധകമെങ്കിൽ)"
]
},
whereToApply: {
en: "Kerala Police Thuna Portal (thuna.keralapolice.gov.in) or official Pol-App mobile application.",
ml: "കേരള പോലീസ് തുണ പോർട്ടൽ (thuna.keralapolice.gov.in) അല്ലെങ്കിൽ പോൽ-ആപ്പ്."
},
mode: {
en: "100% Online with Police Station Follow-up",
ml: "പൂർണ്ണമായും ഓൺലൈൻ & പോലീസ് സ്റ്റേഷൻ"
},
steps: {
en: [
"Register with mobile OTP on Thuna portal or Pol-App.",
"Choose 'Complaint Registration', select district and police station limits.",
"Type petition facts and upload evidentiary attachments.",
"Submit and receive immediate petition receipt number; station House Officer initiates inquiry."
],
ml: [
"തുണ പോർട്ടലിൽ മൊബൈൽ നമ്പർ ഉപയോഗിച്ച് ലോഗിൻ ചെയ്യുക.",
"ജില്ലയും പോലീസ് സ്റ്റേഷനും തിരഞ്ഞെടുത്ത് പരാതി രേഖപ്പെടുത്തുക.",
"തെളിവുകൾ അപ്‌ലോഡ് ചെയ്ത് സമർപ്പിക്കുക.",
"ലഭിക്കുന്ന പെറ്റീഷൻ നമ്പർ ഉപയോഗിച്ച് അന്വേഷണ പുരോഗതി പരിശോധിക്കുക."
]
},
officialUrl: "https://thuna.keralapolice.gov.in",
notes: {
en: "Cybercrimes involving financial loss should also be reported immediately to national cyber helpline 1930.",
ml: "സാമ്പത്തിക തട്ടിപ്പുകളാണെങ്കിൽ ഉടൻ തന്നെ 1930 എന്ന സൈബർ ക്രൈം ഹെൽപ്പ് ലൈനിലും അറിയിക്കുക."
},
lastVerified: "September 2026",
verified: true
},
{
id: "crop-loss-assistance-calamity",
category: "government",
icon: "🌾",
name: {
en: "Crop Loss Assistance due to Natural Calamity",
ml: "പ്രകൃതിദുരന്തം മൂലമുള്ള വിളനാശ സഹായം"
},
summary: {
en: "State Disaster Relief Fund assistance provided to farmers for agricultural destruction caused by floods, droughts, or landslides.",
ml: "വെള്ളപ്പൊക്കം, വരൾച്ച, ഉരുൾപൊട്ടൽ തുടങ്ങിയ പ്രകൃതിദുരന്തങ്ങൾ മൂലം വിളകൾ നശിച്ച കർഷകർക്ക് സർക്കാർ നൽകുന്ന ധനസഹായം."
},
whoNeeds: {
en: "Farmers whose cultivated crops have suffered severe damage due to notified weather calamities in Kerala.",
ml: "പ്രകൃതിക്ഷോഭം മൂലം കൃഷിനാശം സംഭവിച്ച കർഷകർ."
},
eligibility: {
en: "Registered farmers owning or lawfully leasing agricultural land in Kerala suffering crop losses exceeding statutory threshold (usually 33%+).",
ml: "കേരളത്തിൽ സ്വന്തമായോ പാട്ടത്തിനെടുത്തോ കൃഷി ചെയ്യുന്ന, പ്രകൃതിദുരന്തത്തിൽ വിളനാശം നേരിട്ട കർഷകർ."
},
documents: {
en: [
"Aadhaar Card",
"Bank Passbook copy (linked with Aadhaar for DBT)",
"Land Tax Receipt (for landowners) or Registered Lease Agreement (for tenant farmers)",
"Photographs of damaged crop field"
],
ml: [
"ആധാർ കാർഡ്",
"ബാങ്ക് പാസ്ബുക്ക് പകർപ്പ്",
"ഭൂനികുതി രസീത് അല്ലെങ്കിൽ പാട്ടക്കരാർ",
"കൃഷിനാശം വ്യക്തമാക്കുന്ന ഫോട്ടോകൾ"
]
},
additionalDocs: {
en: [
"AIMS (Agricultural Information Management System) farmer registration number"
],
ml: [
"എയിംസ് (AIMS) പോർട്ടൽ ഫാർമർ രജിസ്ട്രേഷൻ നമ്പർ"
]
},
whereToApply: {
en: "AIMS Kerala Portal (aims.kerala.gov.in) or local Krishi Bhavan / Agricultural Officer.",
ml: "എയിംസ് പോർട്ടൽ (aims.kerala.gov.in) അല്ലെങ്കിൽ അടുത്തുള്ള കൃഷിഭവൻ."
},
mode: {
en: "Online (AIMS) & Field Inspection",
ml: "ഓൺലൈൻ & കൃഷിഭവൻ പരിശോധന"
},
steps: {
en: [
"Report damage on AIMS portal within statutory window (usually within 10-15 days of calamity).",
"Upload crop damage details, location coordinates, and land tax receipt.",
"Agricultural Officer conducts site inspection to estimate extent of loss.",
"Sanctioned relief amount is credited directly to farmer's bank account via DBT."
],
ml: [
"വിളനാശം സംഭവിച്ച് നിശ്ചിത ദിവസങ്ങൾക്കകം എയിംസ് പോർട്ടൽ വഴി അപേക്ഷിക്കുക.",
"സ്ഥലത്തിന്റെ വിവരങ്ങളും ഫോട്ടോകളും രേഖകളും നൽകുക.",
"കൃഷി ഓഫീസർ സ്ഥലം സന്ദർശിച്ച് നഷ്ടം തിട്ടപ്പെടുത്തുന്നു.",
"ധനസഹായം നേരിട്ട് കർഷകന്റെ ബാങ്ക് അക്കൗണ്ടിലേക്ക് ലഭിക്കുന്നു."
]
},
officialUrl: "https://aims.kerala.gov.in",
notes: {
en: "Report loss immediately after the disaster occurs; late applications beyond statutory notification windows risk disqualification.",
ml: "ദുരന്തം സംഭവിച്ച് നിശ്ചിത ദിവസങ്ങൾക്കകം തന്നെ അപേക്ഷ നൽകാൻ ശ്രദ്ധിക്കുക."
},
lastVerified: "September 2026",
verified: true
},
...
icon: "🧑‍🌾",
name: {
en: "Karshaka Pension (Agricultural Worker / Farmer Pension)",
ml: "കർഷക പെൻഷൻ"
},
summary: {
en: "Monthly social security pension paid to aged traditional agricultural laborers and small farmers in Kerala.",
ml: "മുതിർന്ന കർഷകർക്കും കർഷകത്തൊഴിലാളികൾക്കും സർക്കാർ നൽകുന്ന പ്രതിമാസ പെൻഷൻ പദ്ധതി."
},
whoNeeds: {
en: "Senior agricultural workers and marginal farmers retired from manual farming activities.",
ml: "60 വയസ്സ് കഴിഞ്ഞ, ഉപജീവനത്തിനായി മറ്റ് മാർഗ്ഗങ്ങളില്ലാത്ത പരമ്പരാഗത കർഷകരും കർഷകത്തൊഴിലാളികളും."
},
eligibility: {
en: "Kerala residents aged 60 or above who engaged in farming for at least 10 years, with annual family income below statutory threshold (typically Rs. 1 Lakh).",
ml: "60 വയസ്സ് കഴിഞ്ഞ, 10 വർഷമെങ്കിലും കൃഷിപ്പണി ചെയ്തിട്ടുള്ള, നിശ്ചിത വരുമാന പരിധിയിലുള്ളവർ."
},
documents: {
en: [
"Aadhaar Card",
...
"Age proof document (School certificate / Electoral roll extract / Medical board certificate)",
"Bank Passbook copy"
],
ml: [
"ആധാർ കാർഡ്",
...
additionalDocs: {
en: [
"Agricultural Worker certificate from Agricultural Officer / Trade union / Local body committee"
],
ml: [
"കൃഷി ഓഫീസറുടെയോ തദ്ദേശ സമിതിയുടെയോ കർഷകത്തൊഴിലാളി സാക്ഷ്യപത്രം"
]
},
whereToApply: {
en: "Local Grama Panchayat / Municipality Office or Sevana Pension portal.",
ml: "ഗ്രാമപഞ്ചായത്ത് / നഗരസഭാ ഓഫീസ് അല്ലെങ്കിൽ സെവന പെൻഷൻ പോർട്ടൽ."
},
mode: {
en: "Offline Application with Online Disbursement",
ml: "നേരിട്ടുള്ള അപേക്ഷ & ഓൺലൈൻ പെൻഷൻ"
},
steps: {
en: [
"Collect application form from Grama Panchayat or download from Sevana Pension portal.",
"Attach income, age proof, agricultural background certificate, and bank passbook.",
"Submit to local body secretary; welfare standing committee investigates entitlement.",
"Panchayat committee sanctions pension; credited monthly via bank or cooperative society."
],
ml: [
"പഞ്ചായത്ത് ഓഫീസിൽ രേഖകൾ സഹിതം അപേക്ഷ നൽകുക.",
"ക്ഷേമകാര്യ സമിതി അന്വേഷണം നടത്തി അർഹത ഉറപ്പുവരുത്തുന്നു.",
"പഞ്ചായത്ത് ഭരണസമിതി അംഗീകരിക്കുന്നതോടെ പെൻഷൻ അനുവദിക്കുന്നു.",
"തുക പ്രതിമാസം ബാങ്ക് അക്കൗണ്ടിലോ സഹകരണ ബാങ്ക് വഴിയോ ലഭിക്കും."
]
},
officialUrl: "https://welfarepension.lsgkerala.gov.in",
notes: {
en: "Recipients must complete annual mustering and income verification to prevent pension interruption.",
ml: "പെൻഷൻ മുടങ്ങാതെ ലഭിക്കാൻ വാർഷിക മസ്റ്ററിംഗ് പൂർത്തിയാക്കേണ്ടതുണ്ട്."
},
lastVerified: "September 2026",
verified: true
},
{
id: "state-crop-insurance-claim",
category: "government",
icon: "💰",
name: {
en: "State Crop Insurance Claim",
ml: "സംസ്ഥാന വിള ഇൻഷുറൻസ് ക്ലെയിം"
},
summary: {
en: "Filing indemnity claims under the Kerala State Crop Insurance Scheme for insured crop losses due to pests, diseases, or weather.",
ml: "കീടബാധ, രോഗങ്ങൾ, കാലാവസ്ഥാ വ്യതിയാനം എന്നിവ മൂലം കൃഷി നശിക്കുമ്പോൾ ഇൻഷുറൻസ് തുക ലഭിക്കുന്നതിനുള്ള ക്ലെയിം സേവനം."
},
whoNeeds: {
en: "Enrolled farmers who paid premiums under Kerala Crop Insurance Scheme and suffered notified crop destruction.",
ml: "സംസ്ഥാന വിള ഇൻഷുറൻസ് പദ്ധതിയിൽ അംഗമായിട്ടുള്ള, വിളനാശം സംഭവിച്ച കർഷകർ."
},
eligibility: {
en: "Active policyholders who remitted insurance premiums for specified crops (Paddy, Banana, Rubber, Coconut, etc.).",
ml: "വിള ഇൻഷുറൻസ് പോളിസി എടുത്ത് കൃത്യമായി പ്രീമിയം അടച്ച കർഷകർക്ക്."
},
documents: {
en: [
"Existing Crop Insurance Policy certificate / receipt number",
"Aadhaar Card",
"Bank Passbook copy (linked to DBT)",
"Photographs of affected crops",
"Land tax receipt / Lease agreement"
],
ml: [
"വിള ഇൻഷുറൻസ് പോളിസി രേഖ / രസീത്",
"ആധാർ കാർഡ്",
"ബാങ്ക് പാസ്ബുക്ക് പകർപ്പ്",
"നശിച്ച വിളകളുടെ ഫോട്ടോകൾ",
"ഭൂനികുതി രസീത് / പാട്ടക്കരാർ"
]
},
additionalDocs: {
en: [
"Loss assessment statement from Krishi Bhavan Agricultural Assistant"
],
ml: [
"കൃഷിഭവൻ ഉദ്യോഗസ്ഥരുടെ നഷ്ടപരിഹാര നിർണ്ണയ റിപ്പോർട്ട്"
]
},
whereToApply: {
en: "AIMS Portal (aims.kerala.gov.in) or jurisdictional Krishi Bhavan.",
ml: "എയിംസ് പോർട്ടൽ (aims.kerala.gov.in) അല്ലെങ്കിൽ ബന്ധപ്പെട്ട കൃഷിഭവൻ."
},
mode: {
en: "Online (AIMS) & Agricultural Officer Verification",
ml: "ഓൺലൈൻ & കൃഷിഭവൻ പരിശോധന"
},
steps: {
en: [
"Log in on AIMS portal and select 'Intimate Crop Loss / Claim'.",
"Select active policy number and specify cause of damage and extent.",
"Agricultural Officer inspects site within statutory period to calculate compensation.",
"Approved insurance compensation is credited directly to the farmer's bank account."
],
ml: [
"എയിംസ് പോർട്ടലിൽ ലോഗിൻ ചെയ്ത് വിളനാശ വിവരം റിപ്പോർട്ട് ചെയ്യുക.",
"പോളിസി നമ്പറും നാശനഷ്ടത്തിന്റെ വിവരങ്ങളും നൽകുക.",
"കൃഷി ഓഫീസർ നേരിട്ടെത്തി പരിശോധന നടത്തുന്നു.",
"ഇൻഷുറൻസ് തുക ബാങ്ക് അക്കൗണ്ടിലേക്ക് ലഭിക്കുന്നു."
]
},
officialUrl: "https://aims.kerala.gov.in",
notes: {
en: "Loss must be reported within 15 days of occurrence; late intimations may not be entertained.",
ml: "വിളനാശം സംഭവിച്ച് 15 ദിവസത്തിനകം വിവരം അറിയിക്കേണ്ടതുണ്ട്."
},
lastVerified: "September 2026",
verified: true
},
{
id: "state-crop-insurance-policy",
category: "government",
icon: "📄",
name: {
en: "State Crop Insurance Policy Registration",
ml: "സംസ്ഥാന വിള ഇൻഷുറൻസ് പോളിസി"
},
summary: {
en: "Enrolling seasonal and perennial crops under the subsidized Comprehensive Crop Insurance Scheme of Kerala.",
ml: "പ്രകൃതിക്ഷോഭങ്ങളിൽ നിന്നും കീടബാധകളിൽ നിന്നുമുള്ള സംരക്ഷണത്തിനായി വിളകൾ ഇൻഷുർ ചെയ്യുന്നതിനുള്ള പദ്ധതി."
},
whoNeeds: {
en: "Farmers cultivating notified major crops (Paddy, Banana, Tapioca, Pepper, Coconut, Cardamom, Rubber, etc.).",
ml: "നെല്ല്, വാഴ, തെങ്ങ്, റബ്ബർ, കുരുമുളക് തുടങ്ങിയ കാർഷിക വിളകൾ കൃഷി ചെയ്യുന്ന കർഷകർ."
},
eligibility: {
en: "Any farmer (owner or licensed tenant) cultivating minimum prescribed number of crop stands in Kerala.",
ml: "കേരളത്തിൽ നിശ്ചിത വിളകൾ കൃഷി ചെയ്യുന്ന ഏതൊരു കർഷകനും."
},
documents: {
en: [
"Aadhaar Card",
"Land Tax Receipt (for own land) or Lease agreement (for lease land)",
"Bank Passbook copy",
"Farmer registration number on AIMS portal"
],
ml: [
"ആധാർ കാർഡ്",
"ഭൂനികുതി രസീത് അല്ലെങ്കിൽ പാട്ടക്കരാർ",
...
additionalDocs: {
en: [
"Details of acreage, crop variety, and planting date"
],
ml: [
"കൃഷി ചെയ്ത വിസ്തീർണ്ണം, വിത്ത് ഇനം, നട്ട തീയതി എന്നിവയുടെ വിവരങ്ങൾ"
]
},
whereToApply: {
en: "AIMS Portal (aims.kerala.gov.in) or local Krishi Bhavan / Akshaya Centre.",
ml: "എയിംസ് പോർട്ടൽ (aims.kerala.gov.in) അല്ലെങ്കിൽ കൃഷിഭവൻ / അക്ഷയ കേന്ദ്രം."
},
mode: {
en: "100% Online",
ml: "പൂർണ്ണമായും ഓൺലൈൻ"
...
steps: {
en: [
"Register farmer profile on AIMS portal using Aadhaar.",
"Select 'Crop Insurance Enrollment', enter crop variety, quantity, and survey numbers.",
"Calculate subsidized nominal premium per plant/acre.",
"Pay premium fee online and download official insurance certificate."
],
ml: [
"എയിംസ് പോർട്ടലിൽ കർഷക വിവരങ്ങൾ രജിസ്റ്റർ ചെയ്യുക.",
"വിളകളുടെ വിവരങ്ങളും സർവേ നമ്പറും നൽകുക.",
"വളരെ ചെറിയ പ്രീമിയം തുക ഓൺലൈനായി അടയ്ക്കുക.",
"ഇൻഷുറൻസ് പോളിസി സർട്ടിഫിക്കറ്റ് ഡൗൺലോഡ് ചെയ്യുക."
]
},
officialUrl: "https://aims.kerala.gov.in",
notes: {
en: "Premiums must be paid within statutory planting intervals (e.g., within 30–45 days of planting for seasonal crops).",
ml: "വിളവിറക്കി നിശ്ചിത ദിവസങ്ങൾക്കുള്ളിൽ തന്നെ പ്രീമിയം അടച്ച് ഇൻഷുറൻസ് പരിരക്ഷ ഉറപ്പാക്കണം."
},
lastVerified: "September 2026",
verified: true
},
{
id: "royalty-cultivable-paddy-land",
category: "government",
icon: "🌾",
name: {
en: "Royalty to Owners of Cultivable Paddy Land",
ml: "കൃഷിയോഗ്യ നെൽവയൽ ഉടമകൾക്കുള്ള റോയൽറ്റി"
},
summary: {
en: "Annual government incentive payment to owners keeping their registered paddy land cultivable and protected.",
ml: "നെൽവയലുകൾ തരിശിടാതെ സംരക്ഷിക്കുകയും കൃഷിയോഗ്യമായി നിലനിർത്തുകയും ചെയ്യുന്ന ഉടമകൾക്ക് സർക്കാർ നൽകുന്ന വാർഷിക റോയൽറ്റി."
},
whoNeeds: {
en: "Paddy field owners in Kerala who actively farm or conserve their wetland plots for ecological agriculture.",
ml: "സ്വന്തം പേരിലുള്ള നെൽവയലുകളിൽ കൃഷി ചെയ്യുന്നവരോ അവ കൃഷിയോഗ്യമായി നിലനിർത്തുന്നവരോ ആയ ഭൂവുടമകൾ."
},
eligibility: {
en: "Owners of cultivable paddy lands recorded as Nilam in Basic Tax Register who have not left the land fallow or converted it.",
ml: "റവന്യൂ രേഖകളിൽ 'നിലം' എന്ന് രേഖപ്പെടുത്തിയിട്ടുള്ള, നെൽവയലുകൾ നികത്താതെ സംരക്ഷിക്കുന്ന ഭൂവുടമകൾ."
},
documents: {
en: [
"Title Deed of the paddy land",
"Latest Land Tax Receipt showing tax remittance as Nilam",
"Aadhaar Card",
"Bank Passbook copy (linked to DBT)",
"Possession Certificate"
],
ml: [
"നെൽവയലിന്റെ ആധാര പകർപ്പ്",
"നിലം എന്ന് രേഖപ്പെടുത്തിയ നടപ്പു വർഷത്തെ ഭൂനികുതി രസീത്",
"ആധാർ കാർഡ്",
"ബാങ്ക് പാസ്ബുക്ക് പകർപ്പ്",
"കൈവശാവകാശ സർട്ടിഫിക്കറ്റ്"
]
...
additionalDocs: {
en: [
"AIMS portal registration reference number"
],
ml: [
"എയിംസ് പോർട്ടൽ രജിസ്ട്രേഷൻ നമ്പർ"
]
},
whereToApply: {
en: "AIMS Portal (aims.kerala.gov.in) or local Krishi Bhavan.",
ml: "എയിംസ് പോർട്ടൽ അല്ലെങ്കിൽ ബന്ധപ്പെട്ട കൃഷിഭവൻ."
},
mode: {
en: "Online (AIMS) & Field Inspection",
ml: "ഓൺലൈൻ & കൃഷിഭവൻ പരിശോധന"
...
steps: {
en: [
"Apply online on AIMS portal under 'Paddy Land Royalty' scheme.",
"Enter survey details, Thandaper number, and land extent.",
"Agricultural Officer verifies that field is kept cultivable and un-reclaimed.",
"Sanctioned royalty amount (currently Rs. 3000/hectare approx) is transferred to bank account."
],
ml: [
"എയിംസ് പോർട്ടൽ വഴി റോയൽറ്റിക്കായി അപേക്ഷിക്കുക.",
"സർവേ നമ്പറും വിസ്തീർണ്ണവും നൽകുക.",
"കൃഷി ഓഫീസർ സ്ഥലം സന്ദർശിച്ച് ഭൂമി കൃഷിയോഗ്യമാണെന്ന് സാക്ഷ്യപ്പെടുത്തുന്നു.",
"റോയൽറ്റി തുക നേരിട്ട് ബാങ്ക് അക്കൗണ്ടിലേക്ക് ലഭിക്കുന്നു."
]
},
officialUrl: "https://aims.kerala.gov.in",
notes: {
en: "Fallow lands left completely uncultivated without conservation efforts are not eligible for royalty grants.",
ml: "കൃഷി ചെയ്യാതെ കാടുകയറി കിടക്കുന്നതോ നികത്തപ്പെട്ടതോ ആയ ഭൂമിക്ക് റോയൽറ്റി ലഭിക്കില്ല."
},
lastVerified: "September 2026",
verified: true
},
